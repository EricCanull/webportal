...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Parking Permits - Vehicle allocation application">
   ...
   if (request.getUserPrincipal() != null) {
      ...
      if (attributes != null) {
        fullname = attributes.containsKey("attribute-fullname") ? (String) attributes.get("attribute-fullname") : fullname;
        firstname = attributes.containsKey("attribute-firstname") ? (String) attributes.get("attribute-firstname") : firstname; 
        role = attributes.containsKey("attribute-role") ? (String) attributes.get("attribute-role") : role;
        thumbnail = attributes.containsKey("attribute-thumbnail") ? URLDecoder.decode((String) attributes.get("attribute-thumbnail"), "UTF-8") : thumbnail;
        } 
    } */
%>
  ...
  <body class="app-home dispatch">
    ...
    <div id="actionContainer">
      <nav class="navbar navbar-expand-lg navbar-dark app-navbar justify-content-between">
        <a class="navbar-brand" href="home.jsp"><i class="fas fa-taxi"></i> PARKING REGISTRATION</a>
          ...
          <ul class="navbar-nav flex-row ml-md-auto ">
            <li class="nav-item dropdown ">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item" href="#" id="main">Main</a>
      ...
      <main role="main" class="main-content">
        <div id="main-content">
          <section class="jumbotron text-center">
            <div class="container">
              <p class="lead text-muted">Parking Permit Application</p>
            </div>
          </section>
          <div class="container">
            <section id="tabs">
                      ...
                      <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-overview-tab" data-toggle="tab"
                           href="#nav-overview" role="tab" aria-controls="nav-overview" aria-selected="true"><i
                              class="fas fa-edit"></i> &nbsp;New Application</a>
                        <a class="nav-item nav-link" id="nav-drivers-tab" data-toggle="tab" href="#nav-drivers"
                           role="tab" aria-controls="nav-drivers" aria-selected="false"><i
                              class="fas fa-list"></i> &nbsp;View Applications</a>
                      </div>
                    </div>
                  </nav>
                      ...
                      <div class="row">
                        <div class="col-md-8 mb-5 mt-5 d-block mx-auto">
                          <form>
                            ...
                            <div class="form-group">
                              <label for="passesnger" class="bmd-label-floating">Term</label>
      ...
      <footer class="text-muted footer text-center">
        <span>Copyright &copy; <a href=#" target="_blank">University
...
<!-- Popper -->
<script src="libs/popper_1.12.0/popper.min.js"></script>
