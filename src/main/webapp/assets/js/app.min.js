!function(t, e) {
    ...
    function _(t, e, n) {
        var i, s, o = (n = n || C).createElement("script");
        if (o.text = t,
        e)
            for (i in h)
    ...
    x.extend = x.fn.extend = function() {
        ...
        a--); a < l; a++)
            if (null != (t = arguments[a]))
                for (e in t)
                    i = t[e],
                    "__proto__" !== e && r !== i && (c && i && (x.isPlainObject(i) || (s = Array.isArray(i))) ? (n = r[e],
                    o = s && !Array.isArray(n) ? [] : s || x.isPlainObject(n) ? n : {},
                    s = !1,
                    r[e] = x.extend(c, o, i)) : void 0 !== i && (r[e] = i));
        return r
    }
    ,
    x.extend({
        ...
        makeArray: function(t, e) {
            var n = e || [];
            return null != t && (p(Object(t)) ? x.merge(n, "string" == typeof t ? [t] : t) : l.call(n, t)),
            n
        },
    ...
    var f = function(n) {
        var t, p, _, o, s, f, u, m, w, l, c, D, k, r, C, g, a, h, v, x = "sizzle" + 1 * new Date, y = n.document, S = 0, i = 0, d = lt(), b = lt(), T = lt(), E = lt(), M = function(t, e) {
            return t === e && (c = !0),
            0
        }, A = {}.hasOwnProperty, e = [], O = e.pop, I = e.push, N = e.push, P = e.slice, L = function(t, e) {
            for (var n = 0, i = t.length; n < i; n++)
                if (t[n] === e)
                    return n;
            return -1
        }, j = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", H = "[\\x20\\t\\r\\n\\f]", Y = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", $ = "\\[" + H + "*(" + Y + ")(?:" + H + "*([*^$|!~]?=)" + H + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + Y + "))|)" + H + "*\\]", R = ":(" + Y + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + $ + ")*)|.*)\\)|)", W = new RegExp(H + "+","g"), U = new RegExp("^" + H + "+|((?:^|[^\\\\])(?:\\\\.)*)" + H + "+$","g"), F = new RegExp("^" + H + "*," + H + "*"), q = new RegExp("^" + H + "*([>+~]|" + H + ")" + H + "*"), B = new RegExp(H + "|>"), V = new RegExp(R), z = new RegExp("^" + Y + "$"), G = {
            ID: new RegExp("^#(" + Y + ")"),
            CLASS: new RegExp("^\\.(" + Y + ")"),
            TAG: new RegExp("^(" + Y + "|[*])"),
            ATTR: new RegExp("^" + $),
        ...
        }, K = /HTML$/i, Q = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, X = /^[^{]+\{\s*\[native \w/, J = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, tt = /[+~]/, et = new RegExp("\\\\([\\da-f]{1,6}" + H + "?|(" + H + ")|.)","ig"), nt = function(t, e, n) {
            var i = "0x" + e - 65536;
        ...
        try {
            N.apply(e = P.call(y.childNodes), y.childNodes),
        ...
        function at(e, t, n, i) {
            var s, o, r, a, l, c, h, u = t && t.ownerDocument, d = t ? t.nodeType : 9;
            if (n = n || [],
            "string" != typeof e || !e || 1 !== d && 9 !== d && 11 !== d)
                return n;
            if (!i && ((t ? t.ownerDocument || t : y) !== k && D(t),
            t = t || k,
            C)) {
                if (11 !== d && (l = J.exec(e)))
                    if (s = l[1]) {
                        if (9 === d) {
                            ...
                            if (r.id === s)
                                return n.push(r),
                                n
                        } else if (u && (r = u.getElementById(s)) && v(t, r) && r.id === s)
                            return n.push(r),
                            n
                    } else {
                        if (l[2])
                ...
                if (p.qsa && !E[e + " "] && (!g || !g.test(e)) && (1 !== d || "object" !== t.nodeName.toLowerCase())) {
                    ...
                    u = t,
                    1 === d && B.test(e)) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(it, st) : t.setAttribute("id", a = x),
                        o = (c = f(e)).length; o--; )
                            c[o] = "#" + a + " " + bt(c[o]);
                        h = c.join(","),
                        u = tt.test(e) && vt(t.parentNode) || t
                    }
                    try {
                        return N.apply(n, u.querySelectorAll(h)),
                        n
                    } catch (t) {
                        E(e, !0)
                    } finally {
        ...
        D = at.setDocument = function(t) {
            ...
            return i !== k && 9 === i.nodeType && i.documentElement && (r = (k = i).documentElement,
            C = !s(k),
            y !== k && (n = k.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", ot, !1) : n.attachEvent && n.attachEvent("onunload", ot)),
            ...
            a = [],
            g = [],
            (p.qsa = X.test(k.querySelectorAll)) && (ht(function(t) {
                r.appendChild(t).innerHTML = "<a id='" + x + "'></a><select id='" + x + "-\r\\' msallowcapture=''><option selected=''></option></select>",
                t.querySelectorAll("[msallowcapture^='']").length && g.push("[*^$]=" + H + "*(?:''|\"\")"),
                t.querySelectorAll("[selected]").length || g.push("\\[" + H + "*(?:value|" + j + ")"),
            ...
            e = X.test(r.compareDocumentPosition),
            v = e || X.test(r.contains) ? function(t, e) {
            ...
            : function(t, e) {
                ...
                if (!s || !o)
                    return t === k ? -1 : e === k ? 1 : s ? -1 : o ? 1 : l ? L(l, t) - L(l, e) : 0;
                if (s === o)
                    return dt(t, e);
        ...
        at.matchesSelector = function(t, e) {
            if ((t.ownerDocument || t) !== k && D(t),
            p.matchesSelector && C && !E[e + " "] && (!a || !a.test(e)) && (!g || !g.test(e)))
                try {
                    var n = h.call(t, e);
        ...
        at.contains = function(t, e) {
            return (t.ownerDocument || t) !== k && D(t),
            v(t, e)
        }
        ,
        ...
        (_ = at.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, n = !t[6] && t[2];
                    return G.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && V.test(n) && (e = f(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e),
                    t[2] = n.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                ATTR: function(n, i, s) {
                    return function(t) {
                        var e = at.attr(t, n);
                        return null == e ? "!=" === i : !i || (e += "",
                        "=" === i ? e === s : "!=" === i ? e !== s : "^=" === i ? s && 0 === e.indexOf(s) : "*=" === i ? s && -1 < e.indexOf(s) : "$=" === i ? s && e.slice(-s.length) === s : "~=" === i ? -1 < (" " + e.replace(W, " ") + " ").indexOf(s) : "|=" === i && (e === s || e.slice(0, s.length + 1) === s + "-"))
                    }
                },
                CHILD: function(f, t, e, m, g) {
                    ...
                    : function(t, e, n) {
                        var i, s, o, r, a, l, c = v !== y ? "nextSibling" : "previousSibling", h = t.parentNode, u = b && t.nodeName.toLowerCase(), d = !n && !b, p = !1;
                        if (h) {
                            if (v) {
                                for (; c; ) {
                                    for (r = t; r = r[c]; )
                            ...
                            if (l = [y ? h.firstChild : h.lastChild],
                            y && d) {
                                for (p = (a = (i = (s = (o = (r = h)[x] || (r[x] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] || [])[0] === S && i[1]) && i[2],
                                r = a && h.childNodes[a]; r = ++a && r && r[c] || (p = a = 0) || l.pop(); )
                                    if (1 === r.nodeType && ++p && r === t) {
                                        s[f] = [S, a, p];
                                        break
                                    }
                            } else if (d && (p = a = (i = (s = (o = (r = t)[x] || (r[x] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] || [])[0] === S && i[1]),
                            !1 === p)
                                for (; (r = ++a && r && r[c] || (p = a = 0) || l.pop()) && ((b ? r.nodeName.toLowerCase() !== u : 1 !== r.nodeType) || !++p || (d && ((s = (o = r[x] || (r[x] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] = [S, p]),
                                r !== t)); )
                                    ;
                ...
                PSEUDO: function(t, o) {
                    ...
                    return r[x] ? r(o) : 1 < r.length ? (e = [t, t, "", o],
            ...
            pseudos: {
                ...
                lang: ct(function(n) {
                    return z.test(n || "") || at.error("unsupported lang: " + n),
        ...
        function _t(a, t, e) {
            ...
            : function(t, e, n) {
                ...
                if (n) {
                    ...
                    for (; t = t[l]; )
                        if (1 === t.nodeType || u)
                            if (s = (o = t[x] || (t[x] = {}))[t.uniqueID] || (o[t.uniqueID] = {}),
                            c && c === t.nodeName.toLowerCase())
                                t = t[l] || t;
                            else {
                                if ((i = s[h]) && i[0] === S && i[1] === d)
                                    return r[2] = i[2];
                                if ((s[h] = r)[2] = a(t, e, n))
                                    return !0
                            }
        ...
        function kt(p, f, m, g, v, t) {
            ...
            v && !v[x] && (v = kt(v, t)),
            ct(function(t, e, n, i) {
                var s, o, r, a = [], l = [], c = e.length, h = t || function(t, e, n) {
                    for (var i = 0, s = e.length; i < s; i++)
                        at(t, e[i], n);
                    return n
                }(f || "*", n.nodeType ? [n] : n, []), u = !p || !t && f ? h : Dt(h, a, p, n, i), d = m ? v || (t ? p : c || g) ? [] : e : u;
                if (m && m(u, d, n, i),
                g)
                    for (s = Dt(d, l),
                    g(s, [], n, i),
                ...
                if (t) {
                    ...
                    d = Dt(d === e ? d.splice(c, d.length) : d),
                    v ? v(null, e, d, i) : N.apply(e, d)
            })
        }
        function Ct(t) {
        ...
        return yt.prototype = _.filters = _.pseudos,
        _.setFilters = new yt,
        f = at.tokenize = function(t, e) {
            ...
            a = [],
            l = _.preFilter; r; ) {
                for (o in n && !(i = F.exec(r)) || (i && (r = r.slice(i[0].length) || r),
                a.push(s = [])),
                n = !1,
                ...
                r = r.slice(n.length)),
                _.filter)
                    !(i = G[o].exec(r)) || l[o] && !(i = l[o](i)) || (n = i.shift(),
                    s.push({
                        value: n,
                        type: o,
                        matches: i
        ...
        u = at.compile = function(t, e) {
            ...
            if (!r) {
                ...
                i = function(t, e, n, i, s) {
                    var o, r, a, l = 0, c = "0", h = t && [], u = [], d = w, p = t || b && _.find.TAG("*", s), f = S += null == d ? 1 : Math.random() || .1, m = p.length;
                    for (s && (w = e === k || e || s); c !== m && null != (o = p[c]); c++) {
                        if (b && o) {
                            for (r = 0,
                            e || o.ownerDocument === k || (D(o),
                            n = !C); a = g[r++]; )
                                if (a(o, e || k, n)) {
                                    i.push(o);
                                    break
                    ...
                    y && c !== l) {
                        ...
                        if (t) {
                            if (0 < l)
                                for (; c--; )
                                    h[c] || u[c] || (u[c] = O.call(i));
                            u = Dt(u)
                        }
                        N.apply(i, u),
                        s && !t && 0 < u.length && 1 < l + v.length && at.uniqueSort(i)
                    }
                    return s && (S = f,
                    w = d),
                    h
        ...
        m = at.select = function(t, e, n, i) {
            var s, o, r, a, l, c = "function" == typeof t && t, h = !i && f(t = c.selector || t);
            if (n = n || [],
            1 === h.length) {
                if (2 < (o = h[0] = h[0].slice(0)).length && "ID" === (r = o[0]).type && 9 === e.nodeType && C && _.relative[o[1].type]) {
                    if (!(e = (_.find.ID(r.matches[0].replace(et, nt), e) || [])[0]))
                        return n;
                    c && (e = e.parentNode),
                    t = t.slice(o.shift().value.length)
                }
                for (s = G.needsContext.test(t) ? 0 : o.length; s-- && (r = o[s],
                !_.relative[a = r.type]); )
            ...
            return (c || u(t, h))(i, e, !C, n, !e || tt.test(t) && vt(e.parentNode) || e),
            n
        }
        ,
        p.sortStable = x.split("").sort(M).join("") === x,
    ...
    x.uniqueSort = x.unique = f.uniqueSort,
    x.text = f.getText,
    x.isXMLDoc = f.isXML,
    x.contains = f.contains,
    x.escapeSelector = f.escape;
    ...
    (x.fn.init = function(t, e, n) {
        ...
        if (!(i = "<" === t[0] && ">" === t[t.length - 1] && 3 <= t.length ? [null, t, null] : I.exec(t)) || !i[1] && e)
            return !e || e.jquery ? (e || n).find(t) : this.constructor(e).find(t);
        if (i[1]) {
            if (e = e instanceof x ? e[0] : e,
            x.merge(this, x.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : C, !0)),
            M.test(i[1]) && x.isPlainObject(e))
                for (i in e)
                    y(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
            return this
        }
        return (s = C.getElementById(i[2])) && (this[0] = s,
        this.length = 1),
        this
    }
    ).prototype = x.fn,
    ...
    x.fn.extend({
        ...
        closest: function(t, e) {
            var n, i = 0, s = this.length, o = [], r = "string" != typeof t && x(t);
            if (!T.test(t))
                for (; i < s; i++)
    ...
    x.each({
        ...
        x.fn[i] = function(t, e) {
            ...
            e && "string" == typeof e && (n = x.filter(e, n)),
            1 < this.length && (P[i] || x.uniqueSort(n),
            N.test(i) && n.reverse()),
            this.pushStack(n)
        }
    });
    ...
    x.Callbacks = function(i) {
        ...
        n = {},
        x.each(t.match(j) || [], function(t, e) {
            n[e] = !0
        }),
        n) : x.extend({}, i);
        var s, e, o, r, a = [], l = [], c = -1, h = function() {
            for (r = r || i.once,
            o = s = !0; l.length; c = -1)
    ...
    x.extend({
                        ...
                        return function() {
                            var n = this
                              ...
                              , t = function() {
                                var t, e;
                                if (!(s < l)) {
                                    if ((t = r.apply(n, i)) === o.promise())
                                        throw new TypeError("Thenable self-resolution");
                                    e = t && ("object" == typeof t || "function" == typeof t) && t.then,
                                    y(e) ? a ? e.call(t, c(l, o, H, a), c(l, o, Y, a)) : (l++,
                                    e.call(t, c(l, o, H, a), c(l, o, Y, a), c(l, o, H, o.notifyWith))) : (r !== H && (n = void 0,
                                    i = [t]),
                                    (a || o.resolveWith)(n, i))
                                }
                            }
                              , e = a ? t : function() {
                                try {
                                    ...
                                    x.Deferred.exceptionHook && x.Deferred.exceptionHook(t, e.stackTrace),
                                    l <= s + 1 && (r !== Y && (n = void 0,
                                    i = [t]),
                                    o.rejectWith(n, i))
                                }
                            ...
                            ;
                            s ? e() : (x.Deferred.getStackHook && (e.stackTrace = x.Deferred.getStackHook()),
                            k.setTimeout(e))
                        }
                    }
                    return x.Deferred(function(t) {
                        o[0][3].add(c(0, t, y(i) ? i : H, t.notifyWith)),
                        o[1][3].add(c(0, t, y(e) ? e : H)),
                        o[2][3].add(c(0, t, y(n) ? n : Y))
                    }).promise()
                },
                promise: function(t) {
        ...
        when: function(t) {
            ...
            if (n <= 1 && ($(t, o.done(r(e)).resolve, o.reject, !n),
            "pending" === o.state() || y(s[e] && s[e].then)))
                return o.then();
            for (; e--; )
                $(s[e], r(e), o.reject);
            return o.promise()
    ...
    x.ready.then = W.then,
    "complete" === C.readyState || "loading" !== C.readyState && !C.documentElement.doScroll ? k.setTimeout(x.ready) : (C.addEventListener("DOMContentLoaded", U),
    ...
    x.fn.extend({
        data: function(n, t) {
            ...
            1 === o.nodeType && !Q.get(o, "hasDataAttrs"))) {
                for (e = r.length; e--; )
                    r[e] && 0 === (i = r[e].name).indexOf("data-") && (i = z(i.slice(5)),
                    tt(o, i, s[i]));
    ...
    x.extend({
        queue: function(t, e, n) {
            ...
            if (t)
                return e = (e || "fx") + "queue",
                i = Q.get(t, e),
                n && (!i || Array.isArray(n) ? i = Q.access(t, e, x.makeArray(n)) : i.push(n)),
                i || []
        },
    ...
    x.fn.extend({
        queue: function(e, n) {
            ...
            e = "fx",
            t--),
            arguments.length < t ? x.queue(this[0], e) : void 0 === n ? this : this.each(function() {
        ...
        promise: function(t, e) {
            var n, i = 1, s = x.Deferred(), o = this, r = this.length, a = function() {
                --i || s.resolveWith(o, [o])
            };
    ...
    function ct(t, e, n, i) {
        ...
        , l = a(), c = n && n[3] || (x.cssNumber[e] ? "" : "px"), h = t.nodeType && (x.cssNumber[e] || "px" !== c && +l) && nt.exec(x.css(t, e));
        if (h && h[3] !== c) {
            for (l /= 2,
            c = c || h[3],
            h = +l || 1; r--; )
    ...
    function ut(t, e) {
        for (var n, i, s, o, r, a, l, c = [], h = 0, u = t.length; h < u; h++)
            ...
            c[h] || (i.style.display = "")),
            "" === i.style.display && at(i) && (c[h] = (l = r = o = void 0,
            r = (s = i).ownerDocument,
            a = s.nodeName,
    ...
    function Mt(t, s, o) {
        ...
        x.event.add(t, s, {
            namespace: !1,
            handler: function(t) {
                var e, n, i = Q.get(this, s);
                if (1 & t.isTrigger && this[s]) {
                    if (i)
                        (x.event.special[s] || {}).delegateType && t.stopPropagation();
                    else if (i = a.call(arguments),
                    Q.set(this, s, i),
                    e = o(this, s),
                    this[s](),
                    i !== (n = Q.get(this, s)) || e ? Q.set(this, s, !1) : n = void 0,
                    i !== n)
                        return t.stopImmediatePropagation(),
                        t.preventDefault(),
                        n
                } else
                    i && (Q.set(this, s, x.event.trigger(x.extend(i.shift(), x.Event.prototype), i, this)),
    ...
    x.event = {
        ...
        add: function(e, t, n, i, s) {
            var o, r, a, l, c, h, u, d, p, f, m, g = Q.get(e);
            if (g)
                for (n.handler && (n = (o = n).handler,
                s = o.selector),
                s && x.find.matchesSelector(st, s),
                ...
                c = (t = (t || "").match(j) || [""]).length; c--; )
                    ...
                    u.setup && !1 !== u.setup.call(e, i, f, r) || e.addEventListener && e.addEventListener(p, r)),
        ...
        remove: function(t, e, n, i, s) {
            var o, r, a, l, c, h, u, d, p, f, m, g = Q.hasData(t) && Q.get(t);
            if (g && (l = g.events)) {
                for (c = (e = (e || "").match(j) || [""]).length; c--; )
                    if (p = m = (a = Ct.exec(e[c]) || [])[1],
                    f = (a[2] || "").split(".").sort(),
                    p) {
                        ...
                        r && !d.length && (u.teardown && !1 !== u.teardown.call(t, f, g.handle) || x.removeEvent(t, p, g.handle),
                        delete l[p])
                    } else
                        for (p in l)
        ...
        dispatch: function(t) {
            var e, n, i, s, o, r, a = x.event.fix(t), l = new Array(arguments.length), c = (Q.get(this, "events") || {})[a.type] || [], h = x.event.special[a.type] || {};
            for (l[0] = a,
            ...
            !h.preDispatch || !1 !== h.preDispatch.call(this, a)) {
                ...
                e = 0; (s = r[e++]) && !a.isPropagationStopped(); )
                    ...
                    n = 0; (o = s.handlers[n++]) && !a.isImmediatePropagationStopped(); )
                        ...
                        a.data = o.data,
                        void 0 !== (i = ((x.event.special[o.origType] || {}).handle || o.handler).apply(s.elem, l)) && !1 === (a.result = i) && (a.preventDefault(),
                        a.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === t.type && 1 <= t.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                        ...
                        r = {},
                        n = 0; n < l; n++)
                            void 0 === r[s = (i = e[n]).selector + " "] && (r[s] = i.needsContext ? -1 < x(s, this).index(c) : x.find(s, this, null, [c]).length),
                            r[s] && o.push(i);
                        o.length && a.push({
                            elem: c,
                            handlers: o
        ...
        special: {
            ...
            click: {
                setup: function(t) {
                    var e = this || t;
                    return dt.test(e.type) && e.click && E(e, "input") && void 0 === Q.get(e, "click") && Mt(e, "click", xt),
                    !1
                },
                trigger: function(t) {
                    var e = this || t;
                    return dt.test(e.type) && e.click && E(e, "input") && void 0 === Q.get(e, "click") && Mt(e, "click"),
                    !0
                },
                _default: function(t) {
                    var e = t.target;
    ...
    x.Event = function(t, e) {
        ...
        this.type = t.type,
        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? xt : St,
    ...
    function Yt(n, i, s, o) {
        i = m.apply([], i);
        var t, e, r, a, l, c, h = 0, u = n.length, d = u - 1, p = i[0], f = y(p);
        if (f || 1 < u && "string" == typeof p && !v.checkClone && It.test(p))
            return n.each(function(t) {
                var e = n.eq(t);
                f && (i[0] = p.call(this, t, e.html())),
                Yt(e, i, s, o)
            });
        if (u && (e = (t = wt(i, n[0].ownerDocument, !1, n, o)).firstChild,
        1 === t.childNodes.length && (t = e),
        e || o)) {
            for (a = (r = x.map(gt(t, "script"), Lt)).length; h < u; h++)
                l = t,
                h !== d && (l = x.clone(l, !0, !0),
                a && x.merge(r, gt(l, "script"))),
                s.call(n[h], l, h);
            if (a)
                ...
                h = 0; h < a; h++)
                    l = r[h],
                    ft.test(l.type || "") && !Q.access(l, "globalEval") && x.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? x._evalUrl && !l.noModule && x._evalUrl(l.src, {
    ...
    function $t(t, e, n) {
        for (var i, s = e ? x.filter(e, t) : t, o = 0; null != (i = s[o]); o++)
            n || 1 !== i.nodeType || x.cleanData(gt(i)),
            i.parentNode && (n && ot(i) && vt(gt(i, "script")),
    ...
    x.extend({
        ...
        clone: function(t, e, n) {
            var i, s, o, r, a, l, c, h = t.cloneNode(!0), u = ot(t);
            if (!(v.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || x.isXMLDoc(t)))
                for (r = gt(h),
                i = 0,
                s = (o = gt(t)).length; i < s; i++)
                    a = o[i],
                    l = r[i],
                    void 0,
                    "input" === (c = l.nodeName.toLowerCase()) && dt.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (e)
                if (n)
                    for (o = o || gt(t),
                    r = r || gt(h),
                    ...
                    Ht(t, h);
            return 0 < (r = gt(h, "script")).length && vt(r, !u && gt(t, "script")),
            h
        },
    ...
    x.fn.extend({
        ...
        html: function(t) {
            return F(this, function(t) {
                ...
                if ("string" == typeof t && !Ot.test(t) && !mt[(pt.exec(t) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n < i; n++)
                            1 === (e = this[n] || {}).nodeType && (x.cleanData(gt(e, !1)),
                            e.innerHTML = t);
                        e = 0
                    } catch (t) {}
                }
        ...
        replaceWith: function() {
            ...
            return Yt(this, arguments, function(t) {
                ...
                x.inArray(this, n) < 0 && (x.cleanData(gt(this)),
    ...
    function Ft(t, e, n) {
        ...
        return (n = n || Wt(t)) && ("" !== (r = n.getPropertyValue(e) || n[e]) || ot(t) || (r = x.style(t, e)),
        !v.pixelBoxStyles() && Rt.test(r) && Ut.test(e) && (i = a.width,
        s = a.minWidth,
        o = a.maxWidth,
    ...
    !function() {
        function t() {
            if (l) {
                ...
                st.appendChild(a).appendChild(l);
        ...
        var n, i, s, o, r, a = C.createElement("div"), l = C.createElement("div");
    ...
    function te(t, e, n, i, s, o) {
        ...
        if (n === (i ? "border" : "content"))
            return 0;
        for (; r < 4; r += 2)
            "margin" === n && (l += x.css(t, n + it[r], !0, s)),
            i ? ("content" === n && (l -= x.css(t, "padding" + it[r], !0, s)),
            "margin" !== n && (l -= x.css(t, "border" + it[r] + "Width", !0, s))) : (l += x.css(t, "padding" + it[r], !0, s),
            "padding" !== n ? l += x.css(t, "border" + it[r] + "Width", !0, s) : a += x.css(t, "border" + it[r] + "Width", !0, s));
    ...
    function ee(t, e, n) {
        ...
        return (!v.boxSizingReliable() && s || "auto" === r || !parseFloat(r) && "inline" === x.css(t, "display", !1, i)) && t.getClientRects().length && (s = "border-box" === x.css(t, "boxSizing", !1, i),
        (o = a in t) && (r = t[a])),
        (r = parseFloat(r) || 0) + te(t, e, n || (s ? "border" : "content"), o, i, r) + "px"
    }
    ...
    x.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var s, o, r, a = z(e), l = Qt.test(e), c = t.style;
                if (l || (e = Gt(a)),
                r = x.cssHooks[e] || x.cssHooks[a],
                void 0 === n)
                    return r && "get"in r && void 0 !== (s = r.get(t, !1, i)) ? s : c[e];
                "string" === (o = typeof n) && (s = nt.exec(n)) && s[1] && (n = ct(t, e, s),
                o = "number"),
                null != n && n == n && ("number" !== o || l || (n += s && s[3] || (x.cssNumber[a] ? "" : "px")),
        ...
        css: function(t, e, n, i) {
            ...
            (r = x.cssHooks[e] || x.cssHooks[a]) && "get"in r && (s = r.get(t, !0, n)),
            void 0 === s && (s = Ft(t, e, i)),
    ...
    x.each(["height", "width"], function(t, l) {
        x.cssHooks[l] = {
            get: function(t, e, n) {
                if (e)
                    return !Kt.test(x.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? ee(t, l, n) : lt(t, Zt, function() {
                        return ee(t, l, n)
                    })
            },
            set: function(t, e, n) {
                var i, s = Wt(t), o = !v.scrollboxSize() && "absolute" === s.position, r = (o || n) && "border-box" === x.css(t, "boxSizing", !1, s), a = n ? te(t, l, n, r, s) : 0;
                return r && o && (a -= Math.ceil(t["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(s[l]) - te(t, l, "border", !1, s) - .5)),
                a && (i = nt.exec(e)) && "px" !== (i[3] || "px") && (t.style[l] = e,
                e = x.css(t, l)),
                Jt(0, e, a)
            }
        }
    ...
    x.fx.step = {};
    var ie, se, oe, re, ae = /^(?:toggle|show|hide)$/, le = /queueHooks$/;
    function ce() {
        se && (!1 === C.hidden && k.requestAnimationFrame ? k.requestAnimationFrame(ce) : k.setTimeout(ce, x.fx.interval),
        x.fx.tick())
    }
    function he() {
    ...
    function pe(o, t, e) {
        var n, r, i = 0, s = pe.prefilters.length, a = x.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (r)
                return !1;
            ...
            n < 1 && s ? e : (s || a.notifyWith(o, [c, 1, 0]),
            a.resolveWith(o, [c]),
            !1)
        }, c = a.promise({
            elem: o,
        ...
        for (!function(t, e) {
            ...
            if (n = pe.prefilters[i].call(c, o, h, c.opts))
    ...
    x.Animation = x.extend(pe, {
        tweeners: {
            "*": [function(t, e) {
                ...
                return ct(n.elem, t, nt.exec(e), n),
                n
            }
            ]
        },
        tweener: function(t, e) {
            for (var n, i = 0, s = (t = y(t) ? (e = t,
            ["*"]) : t.match(j)).length; i < s; i++)
                n = t[i],
                pe.tweeners[n] = pe.tweeners[n] || [],
                pe.tweeners[n].unshift(e)
        },
        prefilters: [function(t, e, n) {
            var i, s, o, r, a, l, c, h, u = "width"in e || "height"in e, d = this, p = {}, f = t.style, m = t.nodeType && at(t), g = Q.get(t, "fxshow");
            for (i in n.queue || (null == (r = x._queueHooks(t, "fx")).unqueued && (r.unqueued = 0,
            a = r.empty.fire,
            ...
            if ((l = !x.isEmptyObject(e)) || !x.isEmptyObject(p))
                ...
                "none" === (h = x.css(t, "display")) && (c ? h = c : (ut([t], !0),
                c = t.style.display || c,
                h = x.css(t, "display"),
                ut([t]))),
                ("inline" === h || "inline-block" === h && null != c) && "none" === x.css(t, "float") && (l || (d.done(function() {
                    f.display = c
                }),
                null == c && (h = f.display,
                c = "none" === h ? "" : h)),
    ...
    x.fn.extend({
        ...
        stop: function(s, t, o) {
            ...
            this.each(function() {
                ...
                for (e = n.length; e--; )
                    n[e].elem !== this || null != s && n[e].queue !== s || (n[e].anim.stop(o),
                    t = !1,
                    n.splice(e, 1));
        ...
        finish: function(r) {
            return !1 !== r && (r = r || "fx"),
            this.each(function() {
                var t, e = Q.get(this), n = e[r + "queue"], i = e[r + "queueHooks"], s = x.timers, o = n ? n.length : 0;
                for (e.finish = !0,
                x.queue(this, r, []),
    ...
    ,
    oe = C.createElement("input"),
    re = C.createElement("select").appendChild(C.createElement("option")),
    oe.type = "checkbox",
    v.checkOn = "" !== oe.value,
    v.optSelected = re.selected,
    (oe = C.createElement("input")).value = "t",
    oe.type = "radio",
    v.radioValue = "t" === oe.value;
    var fe, me = x.expr.attrHandle;
    x.fn.extend({
        attr: function(t, e) {
    ...
    x.extend({
        attr: function(t, e, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === t.getAttribute ? x.prop(t, e, n) : (1 === o && x.isXMLDoc(t) || (s = x.attrHooks[e.toLowerCase()] || (x.expr.match.bool.test(e) ? fe : void 0)),
                void 0 !== n ? null === n ? void x.removeAttr(t, e) : s && "set"in s && void 0 !== (i = s.set(t, n, e)) ? i : (t.setAttribute(e, n + ""),
                n) : s && "get"in s && null !== (i = s.get(t, e)) ? i : null == (i = x.find.attr(t, e)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
        ...
        toggleClass: function(s, e) {
            ...
            return "boolean" == typeof e && r ? e ? this.addClass(s) : this.removeClass(s) : y(s) ? this.each(function(t) {
                ...
                if (r)
                    ...
                    void 0 !== s && "boolean" !== o || ((t = be(this)) && Q.set(this, "__className__", t),
                    this.setAttribute && this.setAttribute("class", t || !1 === s ? "" : Q.get(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            var e, n, i = 0;
            for (e = " " + t + " "; n = this[i++]; )
                if (1 === n.nodeType && -1 < (" " + ye(be(n)) + " ").indexOf(e))
                    return !0;
            return !1
        }
    });
    ...
    x.extend(x.event, {
        trigger: function(t, e, n, i) {
            var s, o, r, a, l, c, h, u, d = [n || C], p = g.call(t, "type") ? t.type : t, f = g.call(t, "namespace") ? t.namespace.split(".") : [];
            if (o = u = r = n = n || C,
            3 !== n.nodeType && 8 !== n.nodeType && !De.test(p + x.event.triggered) && (-1 < p.indexOf(".") && (p = (f = p.split(".")).shift(),
            f.sort()),
            l = p.indexOf(":") < 0 && "on" + p,
            (t = t[x.expando] ? t : new x.Event(p,"object" == typeof t && t)).isTrigger = i ? 2 : 3,
            t.namespace = f.join("."),
            ...
            i || !h.trigger || !1 !== h.trigger.apply(n, e))) {
                if (!i && !h.noBubble && !b(n)) {
                    for (a = h.delegateType || p,
                    De.test(a + p) || (o = o.parentNode); o; o = o.parentNode)
                        d.push(o),
                        r = o;
                ...
                for (s = 0; (o = d[s++]) && !t.isPropagationStopped(); )
                    ...
                    (c = l && o[l]) && c.apply && G(o) && (t.result = c.apply(o, e),
                    !1 === t.result && t.preventDefault());
                return t.type = p,
                i || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(d.pop(), e) || !G(n) || l && y(n[p]) && !b(n) && ((r = n[l]) && (n[l] = null),
                x.event.triggered = p,
                t.isPropagationStopped() && u.addEventListener(p, ke),
                n[p](),
                t.isPropagationStopped() && u.removeEventListener(p, ke),
        ...
        x.event.special[i] = {
            setup: function() {
                var t = this.ownerDocument || this
                  , e = Q.access(t, i);
                e || t.addEventListener(n, s, !0),
                Q.access(t, i, (e || 0) + 1)
            },
            teardown: function() {
                var t = this.ownerDocument || this
                  , e = Q.access(t, i) - 1;
                e ? Q.access(t, i, e) : (t.removeEventListener(n, s, !0),
                Q.remove(t, i))
            }
        }
    });
    ...
    function Ue(o) {
        return function(t, e) {
            "string" != typeof t && (e = t,
            t = "*");
            var n, i = 0, s = t.toLowerCase().match(j) || [];
            if (y(e))
                for (; n = s[i++]; )
                    "+" === n[0] ? (n = n.slice(1) || "*",
    ...
    function Fe(e, s, o, r) {
        ...
        function c(t) {
            ...
            x.each(e[t] || [], function(t, e) {
                var n = e(s, o, r);
                return "string" != typeof n || l || a[n] ? l ? !(i = n) : void 0 : (s.dataTypes.unshift(n),
                c(n),
                !1)
            }),
            i
    ...
    x.extend({
        ...
        ajax: function(t, e) {
            ...
            t = void 0),
            e = e || {};
            var h, u, d, n, p, i, f, m, s, o, g = x.ajaxSetup({}, e), v = g.context || g, y = g.context && (v.nodeType || v.jquery) ? x(v) : x.event, b = x.Deferred(), _ = x.Callbacks("once memory"), w = g.statusCode || {}, r = {}, a = {}, l = "canceled", D = {
                readyState: 0,
            ...
            if (b.promise(D),
            g.url = ((t || g.url || Ce.href) + "").replace(He, Ce.protocol + "//"),
            ...
            null == g.crossDomain) {
                ...
                try {
                    i.href = g.url,
                    i.href = i.href,
                    g.crossDomain = We.protocol + "//" + We.host != i.protocol + "//" + i.host
                } catch (t) {
                    g.crossDomain = !0
                }
            }
            ...
            f)
                return D;
            for (s in (m = x.event && g.global) && 0 == x.active++ && x.event.trigger("ajaxStart"),
            g.type = g.type.toUpperCase(),
            g.hasContent = !je.test(g.type),
            u = g.url.replace(Ne, ""),
            g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(Ie, "+")) : (o = g.url.slice(u.length),
            g.data && (g.processData || "string" == typeof g.data) && (u += (Se.test(u) ? "&" : "?") + g.data,
            delete g.data),
            !1 === g.cache && (u = u.replace(Pe, "$1"),
            o = (Se.test(u) ? "&" : "?") + "_=" + xe++ + o),
            g.url = u + o),
            g.ifModified && (x.lastModified[u] && D.setRequestHeader("If-Modified-Since", x.lastModified[u]),
            x.etag[u] && D.setRequestHeader("If-None-Match", x.etag[u])),
            (g.data && g.hasContent && !1 !== g.contentType || e.contentType) && D.setRequestHeader("Content-Type", g.contentType),
            D.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Re + "; q=0.01" : "") : g.accepts["*"]),
            g.headers)
                D.setRequestHeader(s, g.headers[s]);
            if (g.beforeSend && (!1 === g.beforeSend.call(v, D, g) || f))
                return D.abort();
            if (l = "abort",
            _.add(g.complete),
            D.done(g.success),
            ...
            function c(t, e, n, i) {
                ...
                s ? (g.ifModified && ((l = D.getResponseHeader("Last-Modified")) && (x.lastModified[u] = l),
                (l = D.getResponseHeader("etag")) && (x.etag[u] = l)),
                ...
                D.status = t,
                D.statusText = (e || c) + "",
                s ? b.resolveWith(v, [o, c, D]) : b.rejectWith(v, [D, c, r]),
                D.statusCode(w),
                w = void 0,
                m && y.trigger(s ? "ajaxSuccess" : "ajaxError", [D, g, s ? o : r]),
                _.fireWith(v, [D, c]),
                m && (y.trigger("ajaxComplete", [D, g]),
    ...
    v.ajax = Ve = !!Ve,
    x.ajaxTransport(function(s) {
        var o, r;
        if (v.cors || Ve && !s.crossDomain)
            return {
                send: function(t, e) {
                    var n, i = s.xhr();
                    ...
                    o = function(t) {
                        return function() {
                            ...
                            "abort" === t ? i.abort() : "error" === t ? "number" != typeof i.status ? e(0, "error") : e(i.status, i.statusText) : e(Be[i.status] || i.status, i.statusText, "text" !== (i.responseType || "text") || "string" != typeof i.responseText ? {
                                binary: i.response
                            } : {
                                text: i.responseText
    ...
    x.ajaxPrefilter("json jsonp", function(t, e, n) {
        var i, s, o, r = !1 !== t.jsonp && (Ke.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Ke.test(t.data) && "data");
        if (r || "jsonp" === t.dataTypes[0])
            return i = t.jsonpCallback = y(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
            r ? t[r] = t[r].replace(Ke, "$1" + i) : !1 !== t.jsonp && (t.url += (Se.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
            ...
            ,
            n.always(function() {
                void 0 === s ? x(k).removeProp(i) : k[i] = s,
    ...
    v.createHTMLDocument = ((ze = C.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    2 === ze.childNodes.length),
    x.parseHTML = function(t, e, n) {
        return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e,
        e = !1),
        e || (v.createHTMLDocument ? ((i = (e = C.implementation.createHTMLDocument("")).createElement("base")).href = C.location.href,
        e.head.appendChild(i)) : e = C),
        o = !n && [],
        (s = M.exec(t)) ? [e.createElement(s[1])] : (s = wt([t], e, o),
    ...
    x.offset = {
        setOffset: function(t, e, n) {
            var i, s, o, r, a, l, c = x.css(t, "position"), h = x(t), u = {};
            "static" === c && (t.style.position = "relative"),
            a = h.offset(),
            o = x.css(t, "top"),
            l = x.css(t, "left"),
            s = ("absolute" === c || "fixed" === c) && -1 < (o + l).indexOf("auto") ? (r = (i = h.position()).top,
            i.left) : (r = parseFloat(o) || 0,
            parseFloat(l) || 0),
            ...
            if (this[0]) {
                ...
                if ("fixed" === x.css(i, "position"))
                    ...
                    t = i.offsetParent || n.documentElement; t && (t === n.body || t === n.documentElement) && "static" === x.css(t, "position"); )
                        t = t.parentNode;
                    t && t !== i && 1 === t.nodeType && ((s = x(t).offset()).top += x.css(t, "borderTopWidth", !0),
    ...
    x.each({
        ...
        x.each({
            ...
            x.fn[o] = function(t, e) {
                ...
                return F(this, function(t, e, n) {
                    var i;
                    return b(t) ? 0 === o.indexOf("outer") ? t["inner" + r] : t.document.documentElement["client" + r] : 9 === t.nodeType ? (i = t.documentElement,
                    Math.max(t.body["scroll" + r], i["scroll" + r], t.body["offset" + r], i["offset" + r], i["client" + r])) : void 0 === n ? x.css(t, e, s) : x.style(t, e, n, s)
                }, a, n ? t : void 0, n)
            }
        })
    }),
...
function(t, e) {
      ...
      , O = function() {
        ...
        return t.toggle = function() {
            ...
            if (n) {
                ...
                if (i) {
                    if ("radio" === i.type)
                        if (i.checked && this._element.classList.contains(D))
                            t = !1;
                        else {
                    ...
                    if (t) {
                        if (i.hasAttribute("disabled") || n.hasAttribute("disabled") || i.classList.contains("disabled") || n.classList.contains("disabled"))
                            return;
                        i.checked = !this._element.classList.contains(D),
                        f(i).trigger("change")
                    }
                    i.focus(),
                    e = !1
            ...
            e && this._element.setAttribute("aria-pressed", !this._element.classList.contains(D)),
            t && f(this._element).toggleClass(D)
        }
        ,
        t.dispose = function() {
    ...
    f(document).on(A.CLICK_DATA_API, x, function(t) {
        t.preventDefault();
        var e = t.target;
        f(e).hasClass(k) || (e = f(e).closest(M)),
      ...
      , at = function() {
        ...
        t.to = function(t) {
            ...
            if (!(t > this._items.length - 1 || t < 0))
                if (this._isSliding)
                    f(this._element).one(F.SLID, function() {
                        return e.to(t)
                    });
                else {
                    if (n === t)
        ...
        t._slide = function(t, e) {
            var n, i, s, o = this, r = this._element.querySelector(J), a = this._getItemIndex(r), l = e || r && this._getItemByDirection(t, r), c = this._getItemIndex(l), h = Boolean(this._interval);
            if (s = t === $ ? (n = G,
            i = K,
            W) : (n = z,
            i = Q,
            ...
            l && f(l).hasClass(B))
                ...
                if (f(this._element).hasClass(V)) {
                    ...
                    f(r).one(m.TRANSITION_END, function() {
                        f(l).removeClass(n + " " + i).addClass(B),
                        f(r).removeClass(B + " " + i + " " + n),
                        o._isSliding = !1,
                        setTimeout(function() {
    ...
    f(document).on(F.CLICK_DATA_API, st, at._dataApiClickHandler),
    f(window).on(F.LOAD_DATA_API, function() {
        for (var t = [].slice.call(document.querySelectorAll(ot)), e = 0, n = t.length; e < n; e++) {
            var i = f(t[e]);
            at._jQueryInterface.call(i, i.data())
        }
    }),
    f.fn[I] = at._jQueryInterface,
    f.fn[I].Constructor = at,
        ...
        t.show = function() {
            ...
            !(t && (e = f(t).not(this._selector).data(ct)) && e._isTransitioning))) {
                ...
                !i.isDefaultPrevented()) {
                    t && (a._jQueryInterface.call(f(t).not(this._selector), "hide"),
                    e || f(t).data(ct, null));
                    var s = this._getDimension();
                    f(this._element).removeClass(gt).addClass(vt),
                    this._element.style[s] = 0,
                    this._triggerArray.length && f(this._triggerArray).removeClass(yt).attr("aria-expanded", !0),
                    this.setTransitioning(!0);
                    var o = "scroll" + (s[0].toUpperCase() + s.slice(1))
                      , r = m.getTransitionDurationFromElement(this._element);
                    f(this._element).one(m.TRANSITION_END, function() {
                        f(n._element).removeClass(vt).addClass(gt).addClass(mt),
                        n._element.style[s] = "",
                        n.setTransitioning(!1),
                        f(n._element).trigger(ft.SHOWN)
            ...
            if (!this._isTransitioning && f(this._element).hasClass(mt)) {
                ...
                !e.isDefaultPrevented()) {
                    ...
                    if (0 < i)
                        for (var s = 0; s < i; s++) {
                            var o = this._triggerArray[s]
                              , r = m.getSelectorFromElement(o);
                            if (null !== r)
                                f([].slice.call(document.querySelectorAll(r))).hasClass(mt) || f(o).addClass(yt).attr("aria-expanded", !1)
                        }
                    this.setTransitioning(!0);
                    ...
                    f(this._element).one(m.TRANSITION_END, function() {
                        ...
                        f(t._element).removeClass(vt).addClass(gt).trigger(ft.HIDDEN)
    ...
    f.fn[lt] = kt._jQueryInterface,
    f.fn[lt].Constructor = kt,
    ...
    function Yt(t, e) {
        ...
        if (t !== l && e !== l || i.contains(s))
            return "BODY" === (a = (r = l).nodeName) || "HTML" !== a && jt(r.firstElementChild) !== r ? jt(l) : l;
        var c = Ht(t);
    ...
    function ie(t, n, e) {
        return (void 0 === e ? t : t.slice(0, function(t, e, n) {
            ...
            t.enabled && Mt(e) && (n.offsets.popper = Vt(n.offsets.popper),
    ...
    function ae(t, e, n, i) {
        n.updateBound = i,
        re(t).addEventListener("resize", n.updateBound, {
            passive: !0
        });
        var s = It(t);
    ...
    function le() {
        ...
        e = this.state,
        re(t).removeEventListener("resize", e.updateBound),
        ...
        modifiers: {
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    ...
                    return b = Math.max(Math.min(r[c] - f, b), 0),
                    t.arrowElement = i,
                    t.offsets.arrow = (qt(n = {}, u, Math.round(b)),
                    qt(n, d, ""),
                    n),
                    t
                },
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(f, m) {
                    if (se(f.instance.modifiers, "inner"))
                        return f;
                    ...
                    return _.forEach(function(t, e) {
                        ...
                        v = f.placement.split("-")[0],
                        y = te(v);
                        var n, i = f.offsets.popper, s = f.offsets.reference, o = Math.floor, r = "left" === v && o(i.right) > o(s.left) || "right" === v && o(i.left) < o(s.right) || "top" === v && o(i.bottom) > o(s.top) || "bottom" === v && o(i.top) < o(s.bottom), a = o(i.left) < o(g.left), l = o(i.right) > o(g.right), c = o(i.top) < o(g.top), h = o(i.bottom) > o(g.bottom), u = "left" === v && a || "right" === v && l || "top" === v && c || "bottom" === v && h, d = -1 !== ["top", "bottom"].indexOf(v), p = !!m.flipVariations && (d && "start" === b && a || d && "end" === b && l || !d && "start" === b && c || !d && "end" === b && h);
                        (r || u || p) && (f.flipped = !0,
                        (r || u) && (v = _[e + 1]),
                        p && (b = "end" === (n = b) ? "start" : "start" === n ? "end" : n),
                        f.placement = v + (b ? "-" + b : ""),
                        f.offsets.popper = Bt({}, f.offsets.popper, ee(f.instance.popper, f.offsets.reference, f.placement)),
                        f = ie(f.instance.modifiers, f, "flip"))
                    }),
                    f
                },
                behavior: "flip",
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var r, a, l, c, h, u, d, p, f, m, g, v, y, b, _ = void 0 !== o ? o : e.gpuAcceleration, w = jt(t.instance.popper), D = zt(w), k = {
                        position: s.position
                    }, C = (r = t,
                    ...
                    b = a ? u : p,
                    {
                        ...
                        bottom: b(c.bottom),
                        right: y(c.right)
                    }), x = "bottom" === n ? "top" : "bottom", S = "right" === i ? "left" : "right", T = oe("transform"), E = void 0, M = void 0;
                    if (M = "bottom" === x ? "HTML" === w.nodeName ? -w.clientHeight + C.bottom : -D.height + C.bottom : C.top,
                    E = "right" === S ? "HTML" === w.nodeName ? -w.clientWidth + C.right : -D.width + C.right : C.left,
                    _ && T)
                        k[T] = "translate3d(" + E + "px, " + M + "px, 0)",
                        k[x] = 0,
                        k[S] = 0,
                    ...
                    return t.attributes = Bt({}, I, t.attributes),
                    t.styles = Bt({}, k, t.styles),
        ...
        return Ft(o, [{
            ...
            value: function() {
                return function() {
                    ...
                    se(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"),
      ...
      , Ke = function() {
                ...
                !e) {
                    ...
                    !i.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            ...
                            var s = this._element;
                            "parent" === this._config.reference ? s = t : m.isElement(this._config.reference) && (s = this._config.reference,
                            void 0 !== this._config.reference.jquery && (s = this._config.reference[0])),
                            "scrollParent" !== this._config.boundary && f(t).addClass(Le),
                            this._popper = new we(s,this._menu,this._getPopperConfig())
                        }
                        "ontouchstart"in document.documentElement && 0 === f(t).closest($e).length && f(document.body).children().on("mouseover", null, f.noop),
                        this._element.focus(),
                        this._element.setAttribute("aria-expanded", !0),
                        f(this._menu).toggleClass(Ae),
                        f(t).toggleClass(Ae).trigger(f.Event(Ee.SHOWN, n))
                    }
                }
            }
        }
        ...
        t.show = function() {
            if (!(this._element.disabled || f(this._element).hasClass(Me) || f(this._menu).hasClass(Ae))) {
                ...
                f(n).trigger(e),
                e.isDefaultPrevented() || (f(this._menu).toggleClass(Ae),
                f(n).toggleClass(Ae).trigger(f.Event(Ee.SHOWN, t)))
            }
        }
        ,
        t.hide = function() {
            if (!this._element.disabled && !f(this._element).hasClass(Me) && f(this._menu).hasClass(Ae)) {
                ...
                f(n).trigger(e),
                e.isDefaultPrevented() || (f(this._menu).toggleClass(Ae),
                f(n).toggleClass(Ae).trigger(f.Event(Ee.HIDDEN, t)))
            }
        }
        ,
        t.dispose = function() {
            f.removeData(this._element, ke),
            f(this._element).off(Ce),
            this._element = null,
        ...
        ,
        t._getConfig = function(t) {
            return t = l({}, this.constructor.Default, f(this._element).data(), t),
            m.typeCheckConfig(De, t, this.constructor.DefaultType),
            t
        }
        ,
        ...
        t._getPlacement = function() {
            var t = f(this._element.parentNode)
              , e = Fe;
            return t.hasClass(Oe) ? (e = We,
            f(this._menu).hasClass(Pe) && (e = Ue)) : t.hasClass(Ie) ? e = Be : t.hasClass(Ne) ? e = Ve : f(this._menu).hasClass(Pe) && (e = qe),
            e
        }
        ,
                ...
                for (var e = [].slice.call(document.querySelectorAll(je)), n = 0, i = e.length; n < i; n++) {
                    ...
                    o) {
                        ...
                        if (f(s).hasClass(Ae) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && f.contains(s, t.target))) {
                            ...
                            f(a).removeClass(Ae),
                            f(s).removeClass(Ae).trigger(f.Event(Ee.HIDDEN, r)))
                        }
                    }
                }
        }
        ...
        c._dataApiKeydownHandler = function(t) {
            if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || f(t.target).closest(Ye).length)) : Te.test(t.which)) && (t.preventDefault(),
            t.stopPropagation(),
            !this.disabled && !f(this).hasClass(Me))) {
    ...
    f.fn[De] = Ke._jQueryInterface,
    f.fn[De].Constructor = Ke,
    f.fn[De].noConflict = function() {
        return f.fn[De] = Se,
        Ke._jQueryInterface
    }
    ;
      ...
      , gn = function() {
        ...
        t.show = function(t) {
            ...
            if (!this._isShown && !this._isTransitioning) {
                ...
                f(this._element).on(nn.CLICK_DISMISS, pn, function(t) {
                    return e.hide(t)
                }),
        ...
        t.hide = function(t) {
            ...
            this._isShown && !this._isTransitioning) {
                ...
                this._isShown && !n.isDefaultPrevented()) {
                    ...
                    this._setEscapeEvent(),
                    this._setResizeEvent(),
                    f(document).off(nn.FOCUSIN),
                    f(this._element).removeClass(cn),
                    f(this._element).off(nn.CLICK_DISMISS),
                    f(this._dialog).off(nn.MOUSEDOWN_DISMISS),
                    i) {
        ...
        t._showElement = function(t) {
            ...
            f(this._dialog).hasClass(sn) ? this._dialog.querySelector(un).scrollTop = 0 : this._element.scrollTop = 0,
            n && m.reflow(this._element),
            f(this._element).addClass(cn),
        ...
        t._hideModal = function() {
            ...
            this._isTransitioning = !1,
            this._showBackdrop(function() {
                f(document.body).removeClass(an),
                t._resetAdjustments(),
                t._resetScrollbar(),
                f(t._element).trigger(nn.HIDDEN)
            })
        }
        ,
        ...
        t._showBackdrop = function(t) {
            ...
            if (this._isShown && this._config.backdrop) {
                ...
                f(this._element).on(nn.CLICK_DISMISS, function(t) {
                    e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && ("static" === e._config.backdrop ? e._element.focus() : e.hide())
                }),
                n && m.reflow(this._backdrop),
                f(this._backdrop).addClass(cn),
                !t)
                    return;
                if (!n)
                    return void t();
    ...
    f.fn[Qe] = gn._jQueryInterface,
    f.fn[Qe].Constructor = gn,
        ...
        for (var n = (new window.DOMParser).parseFromString(t, "text/html"), a = Object.keys(r), l = [].slice.call(n.body.querySelectorAll("*")), i = function(t, e) {
            ...
            s.forEach(function(t) {
                (function(t, e) {
                    ...
                    if (-1 !== e.indexOf(n))
                        return -1 === vn.indexOf(n) || Boolean(t.nodeValue.match(bn) || t.nodeValue.match(_n));
      ...
      , Fn = function() {
        ...
        t.toggle = function(t) {
            if (this._isEnabled)
                if (t) {
                    ...
                    f(t.currentTarget).data(e, n)),
                    n._activeTrigger.click = !n._activeTrigger.click,
                    n._isWithActiveTrigger() ? n._enter(null, n) : n._leave(null, n)
                } else {
                    if (f(this.getTipElement()).hasClass(jn))
        ...
        t.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                this.setContent(),
                this.config.animation && f(s).addClass(Ln);
                ...
                this._popper = new we(this.element,s,{
                    placement: a,
                    modifiers: {
                        offset: this._getOffset(),
                        flip: {
        ...
        t.hide = function(t) {
            var e = this
              ...
              , s = function() {
                e._hoverState !== In && n.parentNode && n.parentNode.removeChild(n),
                e._cleanTipClass(),
                e.element.removeAttribute("aria-describedby"),
                f(e.element).trigger(e.constructor.Event.HIDDEN),
                null !== e._popper && e._popper.destroy(),
                t && t()
            };
            if (f(this.element).trigger(i),
            !i.isDefaultPrevented()) {
                if (f(n).removeClass(jn),
        ...
        t.setContent = function() {
            ...
            this.setElementContent(f(t.querySelectorAll(Hn)), this.getTitle()),
            f(t).removeClass(Ln + " " + jn)
        }
        ,
        ...
        t._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(t) {
                if ("click" === t)
                    f(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(t) {
                        return i.toggle(t)
                    });
                else if (t !== Un) {
        ...
        t._enter = function(t, e) {
            ...
            (e = e || f(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget,this._getDelegateConfig()),
            f(t.currentTarget).data(n, e)),
            t && (e._activeTrigger["focusin" === t.type ? Rn : $n] = !0),
            f(e.getTipElement()).hasClass(jn) || e._hoverState === In ? e._hoverState = In : (clearTimeout(e._timeout),
            e._hoverState = In,
        ...
        t._leave = function(t, e) {
            ...
            (e = e || f(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget,this._getDelegateConfig()),
            f(t.currentTarget).data(n, e)),
            t && (e._activeTrigger["focusout" === t.type ? Rn : $n] = !1),
        ...
        t._getConfig = function(t) {
            ...
            m.typeCheckConfig(Dn, t, this.constructor.DefaultType),
        ...
        t._fixTransition = function() {
            ...
            null === t.getAttribute("x-placement") && (f(t).removeClass(Ln),
    ...
    f.fn[Dn] = Fn._jQueryInterface,
    f.fn[Dn].Constructor = Fn,
    f.fn[Dn].noConflict = function() {
        return f.fn[Dn] = xn,
        Fn._jQueryInterface
    }
    ;
    ...
    f.fn[qn] = ii._jQueryInterface,
    f.fn[qn].Constructor = ii,
    ...
    var si = "scrollspy"
      ...
      , ki = function() {
        function n(t, e) {
            ...
            f(this._scrollElement).on(hi.SCROLL, function(t) {
                return n._process(t)
            }),
            this.refresh(),
            this._process()
        ...
        ,
        t.dispose = function() {
            f.removeData(this._element, oi),
            f(this._scrollElement).off(ri),
            this._element = null,
        ...
        t._getConfig = function(t) {
            ...
            return m.typeCheckConfig(si, t, ci),
            t
        }
        ,
        ...
        t._activate = function(e) {
            ...
            n.hasClass(ui) ? (n.closest(yi).find(_i).addClass(di),
            n.addClass(di)) : (n.addClass(di),
            n.parents(fi).prev(mi + ", " + vi).addClass(di),
            n.parents(fi).prev(gi).children(mi).addClass(di)),
            f(this._scrollElement).trigger(hi.ACTIVATE, {
                relatedTarget: e
            })
        }
        ,
    ...
    f.fn[si] = ki._jQueryInterface,
    f.fn[si].Constructor = ki,
      ...
      , Ri = function() {
        ...
        return t.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && f(this._element).hasClass(Mi) || f(this._element).hasClass(Ai))) {
                var t, i, e = f(this._element).closest(Pi)[0], s = m.getSelectorFromElement(this._element);
                if (e) {
        ...
        t._transitionComplete = function(t, e, n) {
            if (e) {
                ...
                i && f(i).removeClass(Mi),
                "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)
            }
            if (f(t).addClass(Mi),
            "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0),
            m.reflow(t),
            t.classList.contains(Oi) && t.classList.add(Ii),
            t.parentNode && f(t.parentNode).hasClass(Ei)) {
    ...
    f(document).on(Ti.CLICK_DATA_API, Hi, function(t) {
        t.preventDefault(),
        Ri._jQueryInterface.call(f(this), "show")
    }),
    f.fn.tab = Ri._jQueryInterface,
    f.fn.tab.Constructor = Ri,
    ...
    var Wi = "toast"
      ...
      , Ji = function() {
        ...
        return t.show = function() {
            var t = this;
            f(this._element).trigger(Bi.SHOW),
            this._config.animation && this._element.classList.add(Vi);
            var e = function() {
                t._element.classList.remove(Ki),
                t._element.classList.add(Gi),
                f(t._element).trigger(Bi.SHOWN),
        ...
        t.hide = function(t) {
            var e = this;
            this._element.classList.contains(Gi) && (f(this._element).trigger(Bi.HIDE),
        ...
        t.dispose = function() {
            ...
            f(this._element).off(Bi.CLICK_DISMISS),
        ...
        ,
        t._getConfig = function(t) {
            return t = l({}, Zi, f(this._element).data(), "object" == typeof t && t ? t : {}),
        ...
        t._close = function() {
            var t = this
              , e = function() {
                ...
                f(t._element).trigger(Bi.HIDDEN)
            };
    ...
    f.fn[Wi] = Ji._jQueryInterface,
    f.fn[Wi].Constructor = Ji,
    f.fn[Wi].noConflict = function() {
        return f.fn[Wi] = qi,
        Ji._jQueryInterface
    }
    ,
...
function(t, e) {
    ...
    function n(s, o) {
        var r = !0;
        return m(function() {
            if (null != d.deprecationHandler && d.deprecationHandler(null, s),
            r) {
    ...
    var i, S = {};
    function T(t, e) {
        null != d.deprecationHandler && d.deprecationHandler(t, e),
        S[t] || (x(e),
        S[t] = !0)
    }
    function E(t) {
    ...
    ;
    var xt, St = Tt("FullYear", !0);
    function Tt(e, n) {
        return function(t) {
            return null != t ? (Mt(this, e, t),
    ...
    function Pt(t, e) {
        ...
        if ("string" == typeof e)
            if (/^\d+$/.test(e))
                e = C(e);
            else if (!h(e = t.localeData().monthsParse(e)))
                return t;
    ...
    function Wt(t, e, n, i, s) {
        ...
        return r = a <= 0 ? kt(o = t - 1) + a : a > kt(t) ? (o = t + 1,
        a - kt(t)) : (o = t,
        a),
        {
            year: o,
    ...
    function le(t, e) {
        var n;
        return t && ((n = c(e) ? he(t) : ce(t, e)) ? ee = n : "undefined" != typeof console && console.warn && console.warn("Locale " + t + " not found. Did you forget to load it?")),
        ee._abbr
    }
    function ce(t, e) {
        if (null === e)
    ...
    function he(t) {
        ...
        return function(t) {
            for (var e, n, i, s, o = 0; o < t.length; ) {
                ...
                n = (n = re(t[o + 1])) ? n.split("-") : null; 0 < e; ) {
                    if (i = ae(s.slice(0, e).join("-")))
                        return i;
                    if (n && n.length >= e && r(s, n, !0) >= e - 1)
                        break;
                    e--
                }
                o++
    ...
    function ue(t) {
        var e, n = t._a;
        return n && -2 === v(t).overflow && (e = n[mt] < 0 || 11 < n[mt] ? mt : n[gt] < 1 || n[gt] > At(n[ft], n[mt]) ? gt : n[vt] < 0 || 24 < n[vt] || 24 === n[vt] && (0 !== n[yt] || 0 !== n[bt] || 0 !== n[_t]) ? vt : n[yt] < 0 || 59 < n[yt] ? yt : n[bt] < 0 || 59 < n[bt] ? bt : n[_t] < 0 || 999 < n[_t] ? _t : -1,
        v(t)._overflowDayOfYear && (e < ft || gt < e) && (e = gt),
        v(t)._overflowWeeks && -1 === e && (e = wt),
        v(t)._overflowWeekday && -1 === e && (e = Dt),
        v(t).overflow = e),
        t
    }
    function de(t, e, n) {
    ...
    function pe(t) {
        ...
        if (!t._d) {
            ...
            for (a = t,
            l = new Date(d.now()),
            i = a._useUTC ? [l.getUTCFullYear(), l.getUTCMonth(), l.getUTCDate()] : [l.getFullYear(), l.getMonth(), l.getDate()],
            t._w && null == t._a[gt] && null == t._a[mt] && function(t) {
                var e, n, i, s, o, r, a, l;
                if (null != (e = t._w).GG || null != e.W || null != e.E)
                    o = 1,
                    r = 4,
                    n = de(e.GG, t._a[ft], Ut(Ee(), 1, 4).year),
                    i = de(e.W, 1),
                    ((s = de(e.E, 1)) < 1 || 7 < s) && (l = !0);
                else {
                    o = t._locale._week.dow,
                    r = t._locale._week.doy;
                    var c = Ut(Ee(), o, r);
                    n = de(e.gg, t._a[ft], c.year),
                    i = de(e.w, c.week),
                    null != e.d ? ((s = e.d) < 0 || 6 < s) && (l = !0) : null != e.e ? (s = e.e + o,
                    (e.e < 0 || 6 < e.e) && (l = !0)) : s = o
                }
                i < 1 || i > Ft(n, o, r) ? v(t)._overflowWeeks = !0 : null != l ? v(t)._overflowWeekday = !0 : (a = Wt(n, i, s, o, r),
                t._a[ft] = a.year,
                t._dayOfYear = a.dayOfYear)
            }(t),
            null != t._dayOfYear && (o = de(t._a[ft], i[ft]),
            (t._dayOfYear > kt(o) || 0 === t._dayOfYear) && (v(t)._overflowDayOfYear = !0),
            n = $t(o, 0, t._dayOfYear),
            ...
            t._d = (t._useUTC ? $t : function(t, e, n, i, s, o, r) {
                var a;
                return t < 100 && 0 <= t ? (a = new Date(t + 400,e,n,i,s,o,r),
    ...
    var fe = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/
      ...
      , be = /^\/?Date\((\-?\d+)/i;
    function _e(t) {
        var e, n, i, s, o, r, a = t._i, l = fe.exec(a) || me.exec(a);
        if (l) {
            for (v(t).iso = !0,
            e = 0,
            n = ve.length; e < n; e++)
    ...
    function Ce(t) {
        ...
        if (s) {
            ...
            n = o,
            i = t,
            e && Vt.indexOf(e) !== new Date(n[0],n[1],n[2]).getDay() && (v(i).weekdayMismatch = !0,
            !(i._isValid = !1)))
                return;
            t._a = o,
    ...
    function xe(t) {
        if (t._f !== d.ISO_8601)
            if (t._f !== d.RFC_2822) {
                t._a = [],
                v(t).empty = !0;
                var e, n, i, s, o, r, a, l, c = "" + t._i, h = c.length, u = 0;
                for (i = q(t._f, t._locale).match(Y) || [],
                e = 0; e < i.length; e++)
                    s = i[e],
                    (n = (c.match(ct(s, t)) || [])[0]) && (0 < (o = c.substr(0, c.indexOf(n))).length && v(t).unusedInput.push(o),
                    c = c.slice(c.indexOf(n) + n.length),
                    u += n.length),
                    W[s] ? (n ? v(t).empty = !1 : v(t).unusedTokens.push(s),
                    r = s,
                    l = t,
                    null != (a = n) && f(ut, r) && ut[r](a, l._a, l, r)) : t._strict && !n && v(t).unusedTokens.push(s);
                v(t).charsLeftOver = h - u,
                0 < c.length && v(t).unusedInput.push(c),
    ...
    function Se(t) {
        ...
        D(o) ? new w(ue(o)) : (u(o) ? t._d = o : a(r) ? function(t) {
            ...
            for (s = 0; s < t._f.length; s++)
                ...
                e._f = t._f[s],
                xe(e),
                y(e) && (o += v(e).charsLeftOver,
                o += 10 * v(e).unusedTokens.length,
                v(e).score = o,
                (null == i || o < i) && (i = o,
                n = e));
            m(t, n || e)
        }(t) : r ? xe(t) : c(n = (e = t)._i) ? e._d = new Date(d.now()) : u(n) ? e._d = new Date(n.valueOf()) : "string" == typeof n ? (i = e,
        null === (s = be.exec(i._i)) ? (_e(i),
        !1 === i._isValid && (delete i._isValid,
        Ce(i),
        !1 === i._isValid && (delete i._isValid,
        d.createFromInputFallback(i)))) : i._d = new Date(+s[1])) : a(n) ? (e._a = p(n.slice(0), function(t) {
        ...
        }(e) : h(n) ? e._d = new Date(n) : d.createFromInputFallback(e),
        y(t) || (t._d = null),
        t))
    }
    function Te(t, e, n, i, s) {
        ...
        r._f = e,
        r._strict = i,
        (o = new w(ue(Se(r))))._nextDay && (o.add(1, "d"),
        o._nextDay = void 0),
        o
    }
    function Ee(t, e, n, i) {
    ...
    function $e(t, e) {
        ...
        i = (D(t) || u(t) ? t.valueOf() : Ee(t).valueOf()) - n.valueOf(),
    ...
    function qe(t, e) {
        ...
        e ? o[e] = t : o.milliseconds = t) : (r = Ue.exec(t)) ? (n = "-" === r[1] ? -1 : 1,
        o = {
            y: 0,
            d: C(r[gt]) * n,
            h: C(r[vt]) * n,
        ...
        o = {
            ...
            e = $e(e, t),
            t.isBefore(e) ? n = Ve(t, e) : ((n = Ve(e, t)).milliseconds = -n.milliseconds,
            n.months = -n.months);
            return n
        }(Ee(o.from), Ee(o.to)),
        (o = {}).ms = s.milliseconds,
        o.M = s.months),
        i = new Ne(o),
        Pe(t) && f(t, "_locale") && (i._locale = t._locale),
        i
    }
    function Be(t, e) {
    ...
    function ze(i, s) {
        return function(t, e) {
            var n;
            return null === e || isNaN(+e) || (T(s, "moment()." + s + "(period, number) is deprecated. Please use moment()." + s + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."),
            n = t,
            t = e,
            e = n),
            Ge(this, qe(t = "string" == typeof t ? +t : t, e), i),
            this
        }
    }
    function Ge(t, e, n, i) {
        ...
        r && Pt(t, Et(t, "Month") + r * n),
        o && Mt(t, "Date", Et(t, "Date") + o * n),
        s && t._d.setTime(t._d.valueOf() + s * n),
        i && d.updateOffset(t, o || r))
    }
    qe.fn = Ne.prototype,
    qe.invalid = function() {
        return qe(NaN)
    ...
    function an(t, e, n, i, s) {
        var o;
        return null == t ? Ut(this, i, s).year : ((o = Ft(t, i, s)) < e && (e = o),
        function(t, e, n, i, s) {
            var o = Wt(t, e, n, i, s)
    ...
    ,
    fn.hour = fn.hours = ne,
    fn.minute = fn.minutes = cn,
    fn.second = fn.seconds = un,
    fn.millisecond = fn.milliseconds = pn,
    fn.utcOffset = function(t, e, n) {
        var i, s = this._offset || 0;
        if (!this.isValid())
            return null != t ? this : NaN;
        if (null == t)
            return this._isUTC ? s : Re(this);
        if ("string" == typeof t) {
            if (null === (t = Ye(ot, t)))
                return this
        } else
            Math.abs(t) < 16 && !n && (t *= 60);
        return !this._isUTC && e && (i = Re(this)),
        this._offset = t,
        this._isUTC = !0,
        null != i && this.add(i, "m"),
        s !== t && (!e || this._changeInProgress ? Ge(this, qe(t - s, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0,
        d.updateOffset(this, !0),
    ...
    ,
    fn.dates = n("dates accessor is deprecated. Use date instead.", ln),
    fn.months = n("months accessor is deprecated. Use month instead", Lt),
    fn.years = n("years accessor is deprecated. Use year instead", St),
    fn.zone = n("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", function(t, e) {
    ...
    function bn(t, e, n, i) {
        e = ("boolean" == typeof t ? h(e) && (n = e,
        e = void 0) : (e = t,
        t = !1,
        h(n = e) && (n = e,
        e = void 0)),
        e || "");
        var s, o = he(), r = t ? o._week.dow : 0;
        if (null != n)
            return vn(e, (n + r) % 7, i, "day");
        var a = [];
        for (s = 0; s < 7; s++)
    ...
    gn.preparse = mn,
    gn.postformat = mn,
    gn.relativeTime = function(t, e, n, i) {
    ...
    gn.monthsRegex = function(t) {
        return this._monthsParseExact ? (f(this, "_monthsRegex") || Yt.call(this),
        t ? this._monthsStrictRegex : this._monthsRegex) : (f(this, "_monthsRegex") || (this._monthsRegex = Ht),
        this._monthsStrictRegex && t ? this._monthsStrictRegex : this._monthsRegex)
    }
    ,
    gn.monthsShortRegex = function(t) {
        return this._monthsParseExact ? (f(this, "_monthsRegex") || Yt.call(this),
        t ? this._monthsShortStrictRegex : this._monthsShortRegex) : (f(this, "_monthsShortRegex") || (this._monthsShortRegex = jt),
    ...
    gn.weekdaysRegex = function(t) {
        return this._weekdaysParseExact ? (f(this, "_weekdaysRegex") || Zt.call(this),
        t ? this._weekdaysStrictRegex : this._weekdaysRegex) : (f(this, "_weekdaysRegex") || (this._weekdaysRegex = Gt),
        this._weekdaysStrictRegex && t ? this._weekdaysStrictRegex : this._weekdaysRegex)
    }
    ,
    gn.weekdaysShortRegex = function(t) {
        return this._weekdaysParseExact ? (f(this, "_weekdaysRegex") || Zt.call(this),
        t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (f(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Kt),
        this._weekdaysShortStrictRegex && t ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
    }
    ,
    gn.weekdaysMinRegex = function(t) {
        return this._weekdaysParseExact ? (f(this, "_weekdaysRegex") || Zt.call(this),
        t ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (f(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Qt),
    ...
    d.lang = n("moment.lang is deprecated. Use moment.locale instead.", le),
    d.langData = n("moment.langData is deprecated. Use moment.localeData instead.", he);
    var _n = Math.abs;
    function wn(t, e, n, i) {
        var s = qe(e, n);
    ...
    function zn() {
        ...
        var t, e, n = Bn(this._milliseconds) / 1e3, i = Bn(this._days), s = Bn(this._months);
        e = k((t = k(n / 60)) / 60),
        n %= 60,
        t %= 60;
        var o = k(s / 12)
    ...
    Gn._bubble = function() {
        ...
        return 0 <= o && 0 <= r && 0 <= a || o <= 0 && r <= 0 && a <= 0 || (o += 864e5 * Dn(Cn(a) + r),
        a = r = 0),
    ...
    Gn.months = Wn,
    Gn.years = Un,
    Gn.humanize = function(t) {
        if (!this.isValid())
            return this.localeData().invalidDate();
        var e, n, i, s, o, r, a, l, c, h, u, d = this.localeData(), p = (n = !t,
        i = d,
        s = qe(e = this).abs(),
        o = Fn(s.as("s")),
        r = Fn(s.as("m")),
        ...
        c = Fn(s.as("M")),
        h = Fn(s.as("y")),
        (u = o <= qn.ss && ["s", o] || o < qn.s && ["ss", o] || r <= 1 && ["m"] || r < qn.m && ["mm", r] || a <= 1 && ["h"] || a < qn.h && ["hh", a] || l <= 1 && ["d"] || l < qn.d && ["dd", l] || c <= 1 && ["M"] || c < qn.M && ["MM", c] || h <= 1 && ["y"] || ["yy", h])[2] = n,
        u[3] = 0 < +e,
        u[4] = i,
        function(t, e, n, i, s) {
    ...
    Gn.locale = Xe,
    Gn.localeData = tn,
    Gn.toIsoString = n("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", zn),
    Gn.lang = Je,
    U("X", 0, 0, "unix"),
    U("x", 0, 0, "valueOf"),
    lt("x", it),
    ...
    ,
    d.normalizeUnits = N,
    d.relativeTimeRounding = function(t) {
        return void 0 === t ? Fn : "function" == typeof t && (Fn = t,
        !0)
    }
    ,
...
function(E) {
    E.fn.extend({
        slimScroll: function(S) {
            ...
            return this.each(function() {
                var i, e, s, n, o, r, a, l, c = "<div></div>", h = 30, u = !1, d = E(this);
                if (d.parent().hasClass(T.wrapperClass)) {
                    var p = d.scrollTop();
                    if (b = d.siblings("." + T.barClass),
                    y = d.siblings("." + T.railClass),
                    k(),
                    E.isPlainObject(S)) {
                        ...
                        if ("scrollTo"in S)
                            p = parseInt(T.scrollTo);
                        else if ("scrollBy"in S)
                            p += parseInt(T.scrollBy);
                    ...
                    d.parent().append(b),
                    d.parent().append(y),
                    T.railDraggable && b.bind("mousedown", function(e) {
                        var n = E(document);
                        return s = !0,
                    ...
                    d.bind("touchmove", function(t) {
                        (u || t.originalEvent.preventDefault(),
                        t.originalEvent.touches.length) && (D((o - t.originalEvent.touches[0].pageY) / T.touchScrollStep, !0),
                        o = t.originalEvent.touches[0].pageY)
                    }),
                    k(),
                    "bottom" === T.start ? (b.css({
                        top: d.outerHeight() - b.outerHeight()
                    }),
                    D(0, !0)) : "top" !== T.start && (D(E(T.start).position().top, null, !0),
                    T.alwaysVisible || b.hide()),
                    v = this,
                ...
                function w(t) {
                    if (i) {
                        ...
                        E(n).closest("." + T.wrapperClass).is(d.parent()) && D(e, !0),
                        t.preventDefault && !u && t.preventDefault(),
                        u || (t.returnValue = !1)
                    }
                }
                function D(t, e, n) {
                    ...
                    if (e && (i = parseInt(b.css("top")) + t * parseInt(T.wheelStep) / 100 * b.outerHeight(),
                ...
                function k() {
                    r = Math.max(d.outerHeight() / d[0].scrollHeight * d.outerHeight(), h),
                    b.css({
                        height: r + "px"
                    });
                ...
                function C() {
                    ...
                    a == ~~a) {
                        ...
                        u = !1;
                    l = a,
                    r >= d.outerHeight() ? u = !0 : (b.stop(!0, !0).fadeIn("fast"),
                    T.railVisible && y.stop(!0, !0).fadeIn("fast"))
                }
                function x() {
                    T.alwaysVisible || (n = setTimeout(function() {
                        T.disableFadeOut && i || e || s || (b.fadeOut("slow"),
                        y.fadeOut("slow"))
                    }, 1e3))
                }
            }),
...
function(t, n) {
    ...
    var i = function(t, e, n) {
        ...
        this.element = $(t),
        this.startDate = Y().startOf("day"),
        this.endDate = Y().endOf("day"),
        this.minDate = !1,
        this.maxDate = !1,
        this.maxSpan = !1,
        this.autoApply = !1,
        ...
        this.minYear = Y().subtract(100, "year").format("YYYY"),
        this.maxYear = Y().add(100, "year").format("YYYY"),
        ...
        "string" == typeof (e = $.extend(this.element.data(), e)).template || e.template instanceof $ || (e.template = '<div class="daterangepicker"><div class="ranges"></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn" type="button"></button><button class="applyBtn" disabled="disabled" type="button"></button> </div></div>'),
        this.parentEl = e.parentEl && $(e.parentEl).length ? $(e.parentEl) : $(this.parentEl),
        this.container = $(e.template).appendTo(this.parentEl),
        ...
        "string" == typeof e.startDate && (this.startDate = Y(e.startDate, this.locale.format)),
        "string" == typeof e.endDate && (this.endDate = Y(e.endDate, this.locale.format)),
        "string" == typeof e.minDate && (this.minDate = Y(e.minDate, this.locale.format)),
        "string" == typeof e.maxDate && (this.maxDate = Y(e.maxDate, this.locale.format)),
        "object" == typeof e.startDate && (this.startDate = Y(e.startDate)),
        "object" == typeof e.endDate && (this.endDate = Y(e.endDate)),
        "object" == typeof e.minDate && (this.minDate = Y(e.minDate)),
        "object" == typeof e.maxDate && (this.maxDate = Y(e.maxDate)),
        ...
        if (void 0 === e.startDate && void 0 === e.endDate && $(this.element).is(":text")) {
            ...
            o = r = null,
            2 == c.length ? (o = Y(c[0], this.locale.format),
            r = Y(c[1], this.locale.format)) : this.singleDatePicker && "" !== l && (o = Y(l, this.locale.format),
            r = Y(l, this.locale.format)),
            null !== o && null !== r && (this.setStartDate(o),
            this.setEndDate(r))
        }
        if ("object" == typeof e.ranges) {
            for (a in e.ranges) {
                o = "string" == typeof e.ranges[a][0] ? Y(e.ranges[a][0], this.locale.format) : Y(e.ranges[a][0]),
                r = "string" == typeof e.ranges[a][1] ? Y(e.ranges[a][1], this.locale.format) : Y(e.ranges[a][1]),
                this.minDate && o.isBefore(this.minDate) && (o = this.minDate.clone());
                var h = this.maxDate;
                if (this.maxSpan && h && o.clone().add(this.maxSpan).isAfter(h) && (h = o.clone().add(this.maxSpan)),
                h && r.isAfter(h) && (r = h.clone()),
                !(this.minDate && r.isBefore(this.minDate, this.timepicker ? "minute" : "day") || h && o.isAfter(h, this.timepicker ? "minute" : "day"))) {
                    var u;
    ...
    return i.prototype = {
        ...
        setStartDate: function(t) {
            "string" == typeof t && (this.startDate = Y(t, this.locale.format)),
            "object" == typeof t && (this.startDate = Y(t)),
            this.timePicker || (this.startDate = this.startDate.startOf("day")),
        ...
        setEndDate: function(t) {
            "string" == typeof t && (this.endDate = Y(t, this.locale.format)),
            "object" == typeof t && (this.endDate = Y(t)),
        ...
        renderCalendar: function(t) {
            var e, n = (e = "left" == t ? this.leftCalendar : this.rightCalendar).month.month(), i = e.month.year(), s = e.month.hour(), o = e.month.minute(), r = e.month.second(), a = Y([i, n]).daysInMonth(), l = Y([i, n, 1]), c = Y([i, n, a]), h = Y(l).subtract(1, "month").month(), u = Y(l).subtract(1, "month").year(), d = Y([u, h]).daysInMonth(), p = l.day();
            (e = []).firstDay = l,
            e.lastDay = c;
            for (var f = 0; f < 6; f++)
                e[f] = [];
            ...
            d < m && (m -= 7),
            p == this.locale.firstDay && (m = d - 6);
            for (var g = Y([u, h, m, 12, o, r]), v = (f = 0,
            0), y = 0; f < 42; f++,
            v++,
            g = Y(g).add(24, "hour"))
                0 < f && v % 7 == 0 && (v = 0,
                y++),
                e[y][v] = g.clone().hour(s).minute(o).second(r),
                g.hour(12),
                this.minDate && e[y][v].format("YYYY-MM-DD") == this.minDate.format("YYYY-MM-DD") && e[y][v].isBefore(this.minDate) && "left" == t && (e[y][v] = this.minDate.clone()),
                this.maxDate && e[y][v].format("YYYY-MM-DD") == this.maxDate.format("YYYY-MM-DD") && e[y][v].isAfter(this.maxDate) && "right" == t && (e[y][v] = this.maxDate.clone());
            "left" == t ? this.leftCalendar.calendar = e : this.rightCalendar.calendar = e;
            var b = "left" == t ? this.minDate : this.startDate
              , _ = this.maxDate
              , w = ("left" == t ? this.startDate : this.endDate,
            this.locale.direction,
            '<table class="table-condensed">');
            w += "<thead>",
            w += "<tr>",
            (this.showWeekNumbers || this.showISOWeekNumbers) && (w += "<th></th>"),
            b && !b.isBefore(e.firstDay) || this.linkedCalendars && "left" != t ? w += "<th></th>" : w += '<th class="prev available"><span></span></th>';
            ...
            if (w += '<th colspan="5" class="month">' + D + "</th>",
            _ && !_.isAfter(e.lastDay) || this.linkedCalendars && "right" != t && !this.singleDatePicker ? w += "<th></th>" : w += '<th class="next available"><span></span></th>',
            w += "</tr>",
            w += "<tr>",
            (this.showWeekNumbers || this.showISOWeekNumbers) && (w += '<th class="week">' + this.locale.weekLabel + "</th>"),
            $.each(this.locale.daysOfWeek, function(t, e) {
                w += "<th>" + e + "</th>"
            }),
            w += "</tr>",
            w += "</thead>",
            ...
            for (y = 0; y < 6; y++) {
                w += "<tr>",
                this.showWeekNumbers ? w += '<td class="week">' + e[y][0].week() + "</td>" : this.showISOWeekNumbers && (w += '<td class="week">' + e[y][0].isoWeek() + "</td>");
                for (v = 0; v < 7; v++) {
                    var P = [];
                    e[y][v].isSame(new Date, "day") && P.push("today"),
                    5 < e[y][v].isoWeekday() && P.push("weekend"),
                    e[y][v].month() != e[1][1].month() && P.push("off", "ends"),
                    this.minDate && e[y][v].isBefore(this.minDate, "day") && P.push("off", "disabled"),
                    _ && e[y][v].isAfter(_, "day") && P.push("off", "disabled"),
                    this.isInvalidDate(e[y][v]) && P.push("off", "disabled"),
                    e[y][v].format("YYYY-MM-DD") == this.startDate.format("YYYY-MM-DD") && P.push("active", "start-date"),
                    null != this.endDate && e[y][v].format("YYYY-MM-DD") == this.endDate.format("YYYY-MM-DD") && P.push("active", "end-date"),
                    null != this.endDate && e[y][v] > this.startDate && e[y][v] < this.endDate && P.push("in-range");
                    ...
                    for (f = 0; f < P.length; f++)
                        ...
                        "disabled" == P[f] && (H = !0);
                    H || (j += "available"),
                    w += '<td class="' + j.replace(/^\s+|\s+$/g, "") + '" data-title="r' + y + "c" + v + '">' + e[y][v].date() + "</td>"
                }
                w += "</tr>"
            }
            w += "</tbody>",
            w += "</table>",
            this.container.find(".drp-calendar." + t + " .calendar-table").html(w)
        },
        renderTimePicker: function(t) {
            if ("right" != t || this.endDate) {
                ...
                "left" == t)
                    ...
                    if ("" != o.html() && (n.hour(isNaN(n.hour()) ? o.find(".hourselect option:selected").val() : n.hour()),
                    n.minute(isNaN(n.minute()) ? o.find(".minuteselect option:selected").val() : n.minute()),
                    n.second(isNaN(n.second()) ? o.find(".secondselect option:selected").val() : n.second()),
                    !this.timePicker24Hour)) {
                ...
                if (!this.timePicker24Hour) {
                    ...
                    12 <= n.hour() ? e += '<option value="AM"' + f + '>AM</option><option value="PM" selected="selected"' + m + ">PM</option>" : e += '<option value="AM" selected="selected"' + f + '>AM</option><option value="PM"' + m + ">PM</option>",
                    e += "</select>"
                }
        ...
        move: function() {
            ...
            if (this.container["up" == this.drops ? "addClass" : "removeClass"]("drop-up"),
            "left" == this.opens) {
        ...
        show: function(t) {
            ...
            $(window).on("resize.daterangepicker", $.proxy(function(t) {
                this.move(t)
            }, this)),
        ...
        clickPrev: function(t) {
            $(t.target).parents(".drp-calendar").hasClass("left") ? (this.leftCalendar.month.subtract(1, "month"),
            this.linkedCalendars && this.rightCalendar.month.subtract(1, "month")) : this.rightCalendar.month.subtract(1, "month"),
            this.updateCalendars()
        },
        clickNext: function(t) {
            $(t.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar.month.add(1, "month") : (this.rightCalendar.month.add(1, "month"),
            ...
            if ($(t.target).hasClass("available")) {
                ...
                if (this.endDate || s.isBefore(this.startDate, "day")) {
                    if (this.timePicker) {
                        ...
                        if (!this.timePicker24Hour)
                            "PM" === (l = this.container.find(".left .ampmselect").val()) && o < 12 && (o += 12),
                            "AM" === l && 12 === o && (o = 0);
                    ...
                    if (this.timePicker) {
                        ...
                        if (!this.timePicker24Hour)
                            "PM" === (l = this.container.find(".right .ampmselect").val()) && o < 12 && (o += 12),
                            "AM" === l && 12 === o && (o = 0);
        ...
        monthOrYearChanged: function(t) {
            ...
            e || (o < this.startDate.year() || o == this.startDate.year() && s < this.startDate.month()) && (s = this.startDate.month(),
            o = this.startDate.year()),
            this.minDate && (o < this.minDate.year() || o == this.minDate.year() && s < this.minDate.month()) && (s = this.minDate.month(),
            o = this.minDate.year()),
            this.maxDate && (o > this.maxDate.year() || o == this.maxDate.year() && s > this.maxDate.month()) && (s = this.maxDate.month(),
            o = this.maxDate.year()),
            e ? (this.leftCalendar.month.month(s).year(o),
            this.linkedCalendars && (this.rightCalendar.month = this.leftCalendar.month.clone().add(1, "month"))) : (this.rightCalendar.month.month(s).year(o),
        ...
        timeChanged: function(t) {
            ...
            if (n) {
                ...
                a.second(o),
                this.setStartDate(a),
                this.singleDatePicker ? this.endDate = this.startDate.clone() : this.endDate && this.endDate.format("YYYY-MM-DD") == a.format("YYYY-MM-DD") && this.endDate.isBefore(a) && this.setEndDate(a.clone())
        ...
        elementChanged: function() {
            if (this.element.is("input") && this.element.val().length) {
                var t = this.element.val().split(this.locale.separator)
                  , e = null
                  , n = null;
                2 === t.length && (e = Y(t[0], this.locale.format),
                n = Y(t[1], this.locale.format)),
                (this.singleDatePicker || null === e || null === n) && (n = e = Y(this.element.val(), this.locale.format)),
                e.isValid() && n.isValid() && (this.setStartDate(e),
                this.setEndDate(n),
                this.updateView())
            }
        },
    ...
    $.fn.daterangepicker = function(t, e) {
        ...
        return this.each(function() {
            ...
            t.data("daterangepicker", new i(t,n,e))
        }),
        this
    }
    ,
...
function(t, e) {
    ...
    var r = function(i) {
        ...
        return i.fn.mmEmulateTransitionEnd = t,
        i.event.special[s.TRANSITION_END] = {
            bindType: e,
            delegateType: e,
            handle: function(t) {
      ...
      , s = function() {
        ...
        return t.init = function() {
            var o = this
              ...
              , t = a(this.element);
            t.addClass(i),
            t.find(r.parentTrigger + "." + u).children(r.triggerElement).attr("aria-expanded", "true"),
            t.find(r.parentTrigger + "." + u).parents(r.parentTrigger).addClass(u),
            t.find(r.parentTrigger + "." + u).parents(r.parentTrigger).children(r.triggerElement).attr("aria-expanded", "true"),
            t.find(r.parentTrigger + "." + u).has(r.subMenu).children(r.subMenu).addClass(p + " " + d),
            t.find(r.parentTrigger).not("." + u).has(r.subMenu).children(r.subMenu).addClass(p),
            t.find(r.parentTrigger).children(r.triggerElement).on(h.CLICK_DATA_API, function(t) {
                var e = a(this);
                if ("true" !== e.attr("aria-disabled")) {
                    ...
                    n.hasClass(u) ? (e.attr("aria-expanded", "false"),
                    o.removeActive(n)) : (e.attr("aria-expanded", "true"),
                    o.setActive(n),
                    r.toggle && (o.removeActive(i),
                    s.attr("aria-expanded", "false"))),
                    r.onTransitionStart && r.onTransitionStart(t)
                }
            })
        }
        ,
        ...
        t.show = function(t) {
            ...
            if (!this.transitioning && !a(t).hasClass(f)) {
                ...
                if (n.trigger(i),
                !i.isDefaultPrevented()) {
                    if (n.parent(this.config.parentTrigger).addClass(u),
                    this.config.toggle) {
                        var s = n.parent(this.config.parentTrigger).siblings().children(this.config.subMenu + "." + d);
                        this.hide(s)
                    }
                    n.removeClass(p).addClass(f).height(0),
                    this.setTransitioning(!0);
                    n.height(t[0].scrollHeight).one(r.TRANSITION_END, function() {
                        e.config && e.element && (n.removeClass(f).addClass(p + " " + d).height(""),
    ...
    return a.fn[t] = s.jQueryInterface,
    a.fn[t].Constructor = s,
...
function(i, e, t, n) {
    ...
    var s = {
        ...
        init: function(t, e) {
            this.prepareOptions(t, i.toast.options),
            this.process()
        },
        prepareOptions: function(t, e) {
            var n = {};
            "string" == typeof t || t instanceof Array ? n.text = t : n = t,
            this.options = i.extend({}, e, n)
        },
        process: function() {
            this.setup(),
            this.addToDom(),
        ...
        setup: function() {
            ...
            -1 !== i.inArray(this.options.icon, this._defaultIcons) && this._toastEl.addClass("jq-icon-" + this.options.icon)),
        ...
        bindToast: function() {
            ...
            this._toastEl.find(".close-jq-toast-single").on("click", function(t) {
                t.preventDefault(),
                "fade" === e.options.showHideTransition ? (e._toastEl.trigger("beforeHide"),
                e._toastEl.fadeOut(function() {
                    e._toastEl.trigger("afterHidden")
                })) : "slide" === e.options.showHideTransition ? (e._toastEl.trigger("beforeHide"),
        ...
        addToDom: function() {
            ...
            i("body").append(t)) : (!this.options.stack || isNaN(parseInt(this.options.stack, 10))) && t.empty(),
...
function(n) {
    ...
    var t = function() {
        if (n && n.fn && n.fn.select2 && n.fn.select2.amd)
            var t = n.fn.select2.amd;
        var e, s, c;
        return t && t.requirejs || (t ? s = t : t = {},
        function(p) {
            function f(t, e) {
                return n.call(t, e)
            }
            function a(t, e) {
                var n, i, s, o, r, a, l, c, h, u, d, p = e && e.split("/"), f = k.map, m = f && f["*"] || {};
                if (t) {
                    for (r = (t = t.split("/")).length - 1,
                    k.nodeIdCompat && x.test(t[r]) && (t[r] = t[r].replace(x, "")),
            ...
            var o, r, b, _, w = {}, D = {}, k = {}, C = {}, n = Object.prototype.hasOwnProperty, i = [].slice, x = /\.js$/;
            b = function(t, e) {
                var n, i, s = l(t), o = s[0], r = e[1];
                return t = s[1],
                o && (n = v(o = a(o, r))),
                o ? t = n && n.normalize ? n.normalize(t, (i = r,
                function(t) {
                    return a(t, i)
                }
                )) : a(t, r) : (o = (s = l(t = a(t, r)))[0],
                t = s[1],
                o && (n = v(o))),
                {
                    f: o ? o + "!" + t : t,
                ...
                "undefined" === d || "function" === d) {
                    ...
                    l = 0; l < e.length; l += 1)
                        if ("require" === (o = (a = b(e[l], c)).f))
                            ...
                            s = u[l] = _.module(t);
                        else if (f(w, o) || f(D, o) || f(C, o))
                            u[l] = v(o);
                        else {
                            if (!a.p)
                                throw new Error(t + " missing " + o);
                            a.p.load(a.n, m(i, !0), g(o), {}),
                            u[l] = w[o]
                        }
                    r = n ? n.apply(w[t], u) : void 0,
                    t && (s && s.exports !== p && s.exports !== w[t] ? w[t] = s.exports : r === p && h || (w[t] = r))
                } else
                    t && (w[t] = n)
            }
            ,
            e = s = r = function(t, e, n, i, s) {
                if ("string" == typeof t)
                    return _[t] ? _[t](e) : v(b(t, y(e)).f);
                if (!t.splice) {
                    if ((k = t).deps && r(k.deps, k.callback),
                    !e)
                        return;
                    e.splice ? (t = e,
                    e = n,
                ...
                i = s),
                i ? o(p, t, e, n) : setTimeout(function() {
                    o(p, t, e, n)
                }, 4),
                r
            }
        ...
        t.define("select2/utils", ["jquery"], function(o) {
            ...
            var s = {
                ...
                Decorate: function(i, s) {
                    function o() {
                        ...
                        0 < e && (t.call(arguments, i.prototype.constructor),
            ...
            return s.GetUniqueElementId = function(t) {
                ...
                t.setAttribute("data-select2-id", e)) : (t.setAttribute("data-select2-id", ++n),
                e = n.toString())),
                e
            }
            ,
        ...
        t.define("select2/results", ["jquery", "./utils"], function(d, p) {
            ...
            i.prototype.highlightFirstItem = function() {
                ...
                0 < e.length ? e.first().trigger("mouseenter") : t.first().trigger("mouseenter"),
            ...
            i.prototype.option = function(t) {
                ...
                for (var i in t.disabled && (delete n["aria-selected"],
            ...
            i.prototype.bind = function(e, t) {
                ...
                d.fn.mousewheel && this.$results.on("mousewheel", function(t) {
                    ...
                    t.preventDefault(),
                    t.stopPropagation()) : s && (l.$results.scrollTop(l.$results.get(0).scrollHeight - l.$results.height()),
                    t.preventDefault(),
                    t.stopPropagation())
                }),
                ...
                0 !== t.length) {
                    for (var e = [], n = 0; n < t.length; n++) {
                        var i = t[n]
                          ...
                          , o = this.display(i, s);
                        s.append(o),
                        s.attr("title", i.title || i.text),
                        a.StoreData(s[0], "data", i),
                        e.push(s)
                    }
        ...
        t.define("select2/selection/allowClear", ["jquery", "../keys", "../utils"], function(s, i, a) {
            ...
            t.prototype.update = function(t, e) {
                if (t.call(this, e),
                !(0 < this.$selection.find(".select2-selection__placeholder").length || 0 === e.length)) {
                    var n = this.options.get("translations").get("removeAllItems")
                      , i = s('<span class="select2-selection__clear" title="' + n() + '">&times;</span>');
                    a.StoreData(i[0], "data", e),
        ...
        t.define("select2/selection/search", ["jquery", "../utils", "../keys"], function(i, r, a) {
            ...
            t.prototype.bind = function(t, e, n) {
                ...
                this.$selection.on("keydown", ".select2-search--inline", function(t) {
                    ...
                    t.which === a.BACKSPACE && "" === i.$search.val()) {
            ...
            return t.prototype.bind = function(t, e, n) {
                ...
                e.on("*", function(t, e) {
                    if (-1 !== r.inArray(t, s)) {
                        ...
                        i.$element.trigger(n),
                        -1 !== r.inArray(t, o) && (e.prevented = n.isDefaultPrevented())
                    }
                })
            }
            ,
        ...
        t.define("select2/data/base", ["../utils"], function(i) {
            ...
            n.prototype.generateResultId = function(t, e) {
                ...
                null != e.id ? n += "-" + e.id.toString() : n += "-" + i.generateChars(4),
                n
            }
            ,
            n
            ...
            n.prototype.query = function(n, i) {
                function t() {
                    var t = e.transport(e, function(t) {
                        ...
                        s.options.get("debug") && window.console && console.error && (e && e.results && o.isArray(e.results) || console.error("Select2: The AJAX results did not return an array in the `results` key of the response.")),
                        i(e)
                    }, function() {
                ...
                "function" == typeof e.url && (e.url = e.url.call(this.$element, n)),
                "function" == typeof e.data && (e.data = e.data.call(this.$element, n)),
                this.ajaxOptions.delay && null != n.term ? (this._queryTimeout && window.clearTimeout(this._queryTimeout),
                this._queryTimeout = window.setTimeout(t, this.ajaxOptions.delay)) : t()
            }
            ,
            n
        }),
        t.define("select2/data/tags", ["jquery"], function(h) {
            ...
            return t.prototype.query = function(t, c, h) {
                var u = this;
                this._removeOldTags(),
                null != c.term && null == c.page ? t.call(this, c, function t(e, n) {
        ...
        t.define("select2/data/tokenizer", ["jquery"], function(u) {
            ...
            t.prototype.query = function(t, e, n) {
                ...
                i.term !== e.term && (this.$search.length && (this.$search.val(i.term),
                this.$search.focus()),
                e.term = i.term),
                t.call(this, e, n)
            }
        ...
        t.define("select2/dropdown/infiniteScroll", ["jquery"], function(s) {
            ...
            t.prototype.createLoadingMore = function() {
                ...
                return t.html(e(this.lastParams)),
                t
            }
            ,
            t
        ...
        t.define("select2/dropdown/attachBody", ["jquery", "../utils"], function(f, a) {
            ...
            t.prototype._positionDropdown = function() {
                ...
                u.left -= p.left,
                e || n || (i = "below"),
                h || !c || e ? !c && h && e && (i = "below") : i = "above",
                ("above" == i || e && "below" !== i) && (u.top = o.top - p.top - r),
        ...
        t.define("select2/defaults", ["jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en"], function(f, m, g, v, y, b, _, w, D, k, C, e, x, S, T, E, M, A, O, I, N, P, L, j, H, Y, $, R, t) {
            ...
            return n.prototype.apply = function(e) {
                if (null == (e = f.extend(!0, {}, this.defaults, e)).dataAdapter) {
                    if (null != e.ajax ? e.dataAdapter = T : null != e.data ? e.dataAdapter = S : e.dataAdapter = x,
                    0 < e.minimumInputLength && (e.dataAdapter = k.Decorate(e.dataAdapter, A)),
                    0 < e.maximumInputLength && (e.dataAdapter = k.Decorate(e.dataAdapter, O)),
                    0 < e.maximumSelectionLength && (e.dataAdapter = k.Decorate(e.dataAdapter, I)),
                    e.tags && (e.dataAdapter = k.Decorate(e.dataAdapter, E)),
                    null == e.tokenSeparators && null == e.tokenizer || (e.dataAdapter = k.Decorate(e.dataAdapter, M)),
                    null != e.query) {
                ...
                if (null == e.resultsAdapter && (e.resultsAdapter = g,
                null != e.ajax && (e.resultsAdapter = k.Decorate(e.resultsAdapter, j)),
                null != e.placeholder && (e.resultsAdapter = k.Decorate(e.resultsAdapter, L)),
                e.selectOnClose && (e.resultsAdapter = k.Decorate(e.resultsAdapter, $))),
                null == e.dropdownAdapter) {
                    ...
                    if (0 !== e.minimumResultsForSearch && (e.dropdownAdapter = k.Decorate(e.dropdownAdapter, Y)),
                    e.closeOnSelect && (e.dropdownAdapter = k.Decorate(e.dropdownAdapter, R)),
                ...
                if (null == e.selectionAdapter) {
                    if (e.multiple ? e.selectionAdapter = y : e.selectionAdapter = v,
                    null != e.placeholder && (e.selectionAdapter = k.Decorate(e.selectionAdapter, b)),
                    e.allowClear && (e.selectionAdapter = k.Decorate(e.selectionAdapter, _)),
                    e.multiple && (e.selectionAdapter = k.Decorate(e.selectionAdapter, w)),
        ...
        t.define("select2/options", ["require", "jquery", "./defaults", "./utils"], function(i, h, s, u) {
            ...
            return t.prototype.fromElement = function(t) {
                ...
                u.GetData(t[0], "select2Tags") && (this.options.debug && window.console && console.warn && console.warn('Select2: The `data-select2-tags` attribute has been changed to use the `data-data` and `data-tags="true"` attributes and will be removed in future versions of Select2.'),
                u.StoreData(t[0], "data", u.GetData(t[0], "select2Tags")),
                u.StoreData(t[0], "tags", !0)),
                u.GetData(t[0], "ajaxUrl") && (this.options.debug && window.console && console.warn && console.warn("Select2: The `data-ajax-url` attribute has been changed to `data-ajax--url` and support for the old attribute will be removed in future versions of Select2."),
        ...
        t.define("select2/core", ["jquery", "./options", "./utils", "./keys"], function(s, c, h, i) {
            var u = function(t, e) {
                null != h.GetData(t[0], "select2") && h.GetData(t[0], "select2").destroy(),
                this.$element = t,
                this.id = this._generateId(t),
                e = e || {},
                this.options = new c(e,t),
                u.__super__.constructor.call(this);
                var n = t.attr("tabindex") || 0;
                h.StoreData(t[0], "old-tabindex", n),
                t.attr("tabindex", "-1");
                ...
                this.selection = new o(t,this.options),
                ...
                this.results = new a(t,this.options,this.dataAdapter),
            ...
            return h.Extend(u, h.Observable),
            ...
            u.prototype._registerEvents = function() {
                ...
                this.on("keypress", function(t) {
                    var e = t.which;
                    n.isOpen() ? e === i.ESC || e === i.TAB || e === i.UP && t.altKey ? (n.close(),
                    t.preventDefault()) : e === i.ENTER ? (n.trigger("results:select", {}),
                    t.preventDefault()) : e === i.SPACE && t.ctrlKey ? (n.trigger("results:toggle", {}),
                    t.preventDefault()) : e === i.UP ? (n.trigger("results:previous", {}),
                    t.preventDefault()) : e === i.DOWN && (n.trigger("results:next", {}),
                    t.preventDefault()) : (e === i.ENTER || e === i.SPACE || e === i.DOWN && t.altKey) && (n.open(),
                    t.preventDefault())
                })
            }
            ,
                ...
                if (!t || !t.target || "OPTION" === t.target.nodeName || "OPTGROUP" === t.target.nodeName) {
                    if (e)
                        if (e.addedNodes && 0 < e.addedNodes.length)
                            ...
                            e.removedNodes && 0 < e.removedNodes.length && (n = !0);
                    else
                        n = !0;
            ...
            u.prototype.render = function() {
                ...
                h.StoreData(t[0], "element", this.$element),
                t
            }
            ,
            u
        ...
        t.define("jquery.select2", ["jquery", "jquery-mousewheel", "./select2/core", "./select2/defaults", "./select2/utils"], function(s, t, o, e, r) {
            ...
            return null == s.fn.select2.defaults && (s.fn.select2.defaults = e),
            o
        }),
        {
            define: t.define,
...
function(t, e, n) {
    ...
    var a = function(c, b, _) {
        var w = {
            ...
            getRegexMask: function() {
                for (var t, e, n, i, s = [], o = 0; o < b.length; o++)
                    (t = D.translation[b.charAt(o)]) ? (e = t.pattern.toString().replace(/.{1}$|^.{1}/g, ""),
                    n = t.optional,
                    (t = t.recursive) ? (s.push(b.charAt(o)),
                    i = {
                        digit: b.charAt(o),
                        pattern: e
            ...
            calculateCaretPosition: function() {
                var t = c.data("mask-previus-value") || ""
                  ...
                  , n = w.getCaret();
                if (t !== e) {
                    var i, s = c.data("mask-previus-caret-pos") || 0, o = (e = e.length,
                    t.length), r = t = 0, a = 0, l = 0;
                    ...
                    o < n ? n = 10 * e : n <= s && s !== o ? w.maskDigitPosMapOld[n] || (n = (s = n) - (l - a) - t,
                    w.maskDigitPosMap[n] && (n = s)) : s < n && (n = n + (a - l) + r)
                }
                return n
            },
            ...
            getMasked: function(t, e) {
                var n, i, s, o = [], r = void 0 === e ? w.val() : e + "", a = 0, l = b.length, c = 0, h = r.length, u = 1, d = "push", p = -1, f = 0, m = [];
                for (i = _.reverse ? (d = "unshift",
                u = -1,
                n = 0,
                a = l - 1,
                c = h - 1,
                ...
                function() {
                    ...
                    var g = b.charAt(a)
                      , v = r.charAt(c)
                      , y = D.translation[g];
                    y ? (v.match(y.pattern) ? (o[d](v),
                    y.recursive && (-1 === p ? p = a : a === n && a !== p && (a = p - u),
                    n === p && (a -= u)),
                    a += u) : v === s ? (f--,
                    s = void 0) : y.optional ? (a += u,
                    c -= u) : y.fallback ? (o[d](y.fallback),
                    a += u,
                    c -= u) : w.invalid.push({
                        p: c,
                        v: v,
                ...
                return r = b.charAt(n),
                l !== h + 1 || D.translation[r] || o.push(r),
                o = o.join(""),
                w.mapMaskdigitPositions(o, m, h),
                o
            },
            mapMaskdigitPositions: function(t, e, n) {
                for (t = _.reverse ? t.length - n : 0,
                w.maskDigitPosMap = {},
                n = 0; n < e.length; n++)
            ...
            callbacks: function(t) {
                ...
                s("onChange", !0 === n, i),
                s("onKeyPress", !0 === n, i),
                s("onComplete", e.length === b.length, i),
                s("onInvalid", 0 < w.invalid.length, [e, t, c, w.invalid, _])
            }
        };
        c = r(c);
        var i, D = this, o = w.val();
        b = "function" == typeof b ? b(w.val(), void 0, c, _) : b,
        D.mask = b,
        D.options = _,
        D.remove = function() {
            var t = w.getCaret();
            return D.options.placeholder && c.removeAttr("placeholder"),
        ...
        D.init = function(t) {
            if (t = t || !1,
            _ = _ || {},
            D.clearIfNotMatch = r.jMaskGlobals.clearIfNotMatch,
            D.byPassKeys = r.jMaskGlobals.byPassKeys,
            D.translation = r.extend({}, r.jMaskGlobals.translation, _.translation),
            D = r.extend(!0, {}, D, _),
            i = w.getRegexMask(),
            t)
                w.events(),
                ...
                _.placeholder && c.attr("placeholder", _.placeholder),
                ...
                e && c.attr("maxlength", b.length).data("mask-maxlength", !0),
                w.destroyEvents(),
                w.events(),
                t = w.getCaret(),
                w.val(w.getMasked()),
    ...
    var e = function() {
      ...
      , l = function(t, e, n) {
        ...
        try {
            ...
            "object" != typeof i || s(i.options) !== s(n) || i.mask !== e
        } catch (t) {}
    }
      , t = function(t) {
    ...
    r.fn.mask = function(t, e) {
        ...
        var n = this.selector
          ...
          , o = function() {
            if (l(this, t, e))
                return r(this).data("mask", new a(this,t,e))
        };
        return r(this).each(o),
        n && "" !== n && s && (clearInterval(r.maskWatchers[n]),
    ...
    r.fn.unmask = function() {
        return clearInterval(r.maskWatchers[this.selector]),
...
function(c) {
    var i = function(e, t) {
        ...
        this.fixNavigationButtons = function() {
            if (o.length || (r.find("a:first").tab("show"),
            o = r.find('li:has([data-toggle="tab"]):first')),
            c(s.previousSelector, e).toggleClass("disabled", n.firstIndex() >= n.currentIndex()),
            c(s.nextSelector, e).toggleClass("disabled", n.currentIndex() >= n.navigationLength()),
            c(s.backSelector, e).toggleClass("disabled", 0 == i.length),
            n.rebindClick(c(s.nextSelector, e), n.next),
            n.rebindClick(c(s.previousSelector, e), n.previous),
            n.rebindClick(c(s.lastSelector, e), n.last),
            n.rebindClick(c(s.firstSelector, e), n.first),
            n.rebindClick(c(s.backSelector, e), n.back),
            s.onTabShow && "function" == typeof s.onTabShow && !1 === s.onTabShow(o, r, n.currentIndex()))
                return !1
        }
        ,
        this.next = function(t) {
            if (e.hasClass("last") || s.onNext && "function" == typeof s.onNext && !1 === s.onNext(o, r, n.nextIndex()))
                return !1;
            t = n.currentIndex(),
            $index = n.nextIndex(),
            $index > n.navigationLength() || (i.push(t),
            r.find('li:has([data-toggle="tab"]):eq(' + $index + ") a").tab("show"))
        }
        ,
        this.previous = function(t) {
            if (e.hasClass("first") || s.onPrevious && "function" == typeof s.onPrevious && !1 === s.onPrevious(o, r, n.previousIndex()))
                return !1;
            t = n.currentIndex(),
            $index = n.previousIndex(),
            $index < 0 || (i.push(t),
            r.find('li:has([data-toggle="tab"]):eq(' + $index + ") a").tab("show"))
        }
        ,
        this.first = function(t) {
            if (s.onFirst && "function" == typeof s.onFirst && !1 === s.onFirst(o, r, n.firstIndex()) || e.hasClass("disabled"))
                return !1;
            i.push(n.currentIndex()),
            r.find('li:has([data-toggle="tab"]):eq(0) a').tab("show")
        }
        ,
        this.last = function(t) {
            if (s.onLast && "function" == typeof s.onLast && !1 === s.onLast(o, r, n.lastIndex()) || e.hasClass("disabled"))
                return !1;
            i.push(n.currentIndex()),
            r.find('li:has([data-toggle="tab"]):eq(' + n.navigationLength() + ") a").tab("show")
        }
        ,
        this.back = function() {
            if (0 == i.length)
                return null;
            var t = i.pop();
            if (s.onBack && "function" == typeof s.onBack && !1 === s.onBack(o, r, t))
                return i.push(t),
                !1;
        ...
        this.show = function(t) {
            0 < (t = isNaN(t) ? e.find('li:has([data-toggle="tab"]) a[href=#' + t + "]") : e.find('li:has([data-toggle="tab"]):eq(' + t + ") a")).length && (i.push(n.currentIndex()),
            t.tab("show"))
        }
        ,
        ...
        this.remove = function(t) {
            ...
            t = r.find('li:has([data-toggle="tab"]):eq(' + t[0] + ")"),
            e && (e = t.find("a").attr("href"),
            c(e).remove()),
            t.remove()
        }
        ;
        var a = function(t) {
            ...
            if (t = e.index(c(t.currentTarget).parent('li:has([data-toggle="tab"])')),
            e = c(e[t]),
            s.onTabClick && "function" == typeof s.onTabClick && !1 === s.onTabClick(o, r, n.currentIndex(), t, e))
                return !1
        }
          , l = function(t) {
            if ($element = c(t.target).parent(),
            t = r.find('li:has([data-toggle="tab"])').index($element),
            $element.hasClass("disabled") || s.onTabChange && "function" == typeof s.onTabChange && !1 === s.onTabChange(o, r, n.currentIndex(), t))
                return !1;
            o = $element,
            n.fixNavigationButtons()
        };
        this.resetWizard = function() {
            c('a[data-toggle="tab"]', r).off("click", a),
            c('a[data-toggle="tab"]', r).off("shown shown.bs.tab", l),
            r = e.find("ul:first", e),
            o = r.find('li:has([data-toggle="tab"]).active', e),
            c('a[data-toggle="tab"]', r).on("click", a),
            c('a[data-toggle="tab"]', r).on("shown shown.bs.tab", l),
            n.fixNavigationButtons()
        }
        ,
        r = e.find("ul:first", e),
        o = r.find('li:has([data-toggle="tab"]).active', e),
        r.hasClass(s.tabClass) || r.addClass(s.tabClass),
        s.onInit && "function" == typeof s.onInit && s.onInit(o, r, 0),
        s.onShow && "function" == typeof s.onShow && s.onShow(o, r, n.nextIndex()),
        c('a[data-toggle="tab"]', r).on("click", a),
        c('a[data-toggle="tab"]', r).on("shown shown.bs.tab", l)
    };
        ...
        if ("string" != typeof n)
            return this.each(function(t) {
                if (!(t = c(this)).data("bootstrapWizard")) {
                    var e = new i(t,n);
                    t.data("bootstrapWizard", e),
                    e.fixNavigationButtons()
                }
            });
        var t = Array.prototype.slice.call(arguments, 1);
        return 1 === t.length && t.toString(),
        this.data("bootstrapWizard")[n](t)
    }
    ,
...
function(f, m, i) {
    ...
    var o = function(t, e) {
        ...
        this.icons = e.icons,
        this.maxHours = e.maxHours,
        this.explicitMode = e.explicitMode,
    ...
    o.prototype = {
        ...
        _init: function() {
            ...
            !1 !== this.template ? this.$widget = f(this.getTemplate()).on("click", f.proxy(this.widgetClick, this)) : this.$widget = !1,
        ...
        decrementMinute: function(t) {
            ...
            this.minute = e < 0 ? (this.decrementHour(),
            e + 60) : e
        },
        decrementSecond: function() {
            var t = this.second - this.secondStep;
            this.second = t < 0 ? (this.decrementMinute(!0),
            t + 60) : t
        },
        ...
        getTemplate: function() {
            var t, e, n, i, s, o;
            switch (s = this.showInputs ? (e = '<input type="text" class="bootstrap-timepicker-hour" maxlength="2"/>',
            ...
            '<input type="text" class="bootstrap-timepicker-meridian" maxlength="2"/>') : (e = '<span class="bootstrap-timepicker-hour"></span>',
        ...
        hideWidget: function() {
            ...
            f(i).off("mousedown.timepicker, touchend.timepicker", this.handleDocumentClick),
            this.isOpen = !1,
            this.$widget.detach())
        },
        highlightUnit: function() {
            this.position = this.getCursorPosition(),
            0 <= this.position && this.position <= 2 ? this.highlightHour() : 3 <= this.position && this.position <= 5 ? this.highlightMinute() : 6 <= this.position && this.position <= 8 ? this.showSeconds ? this.highlightSecond() : this.highlightMeridian() : 9 <= this.position && this.position <= 11 && this.highlightMeridian()
        },
        ...
        incrementMinute: function(t) {
            ...
            this.minute = 59 < e ? (this.incrementHour(),
            e - 60) : e
        },
        incrementSecond: function() {
            var t = this.second + this.secondStep - this.second % this.secondStep;
            this.second = 59 < t ? (this.incrementMinute(!0),
            t - 60) : t
        },
        mousewheel: function(t) {
            if (!this.disableMousewheel) {
                ...
                var e = t.originalEvent.wheelDelta || -t.originalEvent.detail
                  , n = null;
                switch ("mousewheel" === t.type ? n = -1 * t.originalEvent.wheelDelta : "DOMMouseScroll" === t.type && (n = 40 * t.originalEvent.detail),
                n && (t.preventDefault(),
                f(this).scrollTop(n + f(this).scrollTop())),
                this.highlightedUnit) {
                case "minute":
                    0 < e ? this.incrementMinute() : this.decrementMinute(),
                    this.highlightMinute();
                    break;
                case "second":
                    0 < e ? this.incrementSecond() : this.decrementSecond(),
                    this.highlightSecond();
                    break;
                case "meridian":
                    this.toggleMeridian(),
                    ...
                    break;
                default:
                    0 < e ? this.incrementHour() : this.decrementHour(),
                    this.highlightHour()
                }
                return !1
            }
        ...
        place: function() {
            if (!this.isInline) {
                ...
                "right" === this.orientation.x && (c -= t - l)) : (this.$widget.addClass("timepicker-orient-left"),
                r.left < 0 ? c -= r.left - 10 : r.left + t > n && (c = n - t - 10));
                var u, d, p = this.orientation.y;
                "auto" === p && (u = -s + r.top - e,
                d = s + i - (r.top + a + e),
                p = Math.max(u, d) === d ? "top" : "bottom"),
                this.$widget.addClass("timepicker-orient-" + p),
                "top" === p ? h += a : h -= e + parseInt(this.$widget.css("padding-top"), 10),
                this.$widget.css({
                    top: h,
                    left: c,
                    zIndex: o
        ...
        setDefaultTime: function(t) {
            if (this.$element.val())
                ...
                i = 0)),
                this.showMeridian && (0 === n ? n = 12 : o = 12 <= n ? (12 < n && (n -= 12),
                "PM") : "AM"),
                this.hour = n,
                this.minute = i,
                this.second = s,
        ...
        setTime: function(t, e) {
            if (t) {
                ...
                if ("object" == typeof t && t.getMonth)
                    ...
                    if (2 < (n = (/a/i.test(t) ? 1 : 0) + (/p/i.test(t) ? 2 : 0)))
                        return void this.clear();
                    if (s = (i = t.replace(/[^0-9\:]/g, "").split(":"))[0] ? i[0].toString() : i.toString(),
                    this.explicitMode && 2 < s.length && s.length % 2 != 0)
                        return void this.clear();
                    o = i[1] ? i[1].toString() : "",
                    r = i[2] ? i[2].toString() : "",
                    4 < s.length && (r = s.slice(-2),
                    s = s.slice(0, -2)),
                    2 < s.length && (o = s.slice(-2),
                    s = s.slice(0, -2)),
                    2 < o.length && (r = o.slice(-2),
                    o = o.slice(0, -2)),
                    s = parseInt(s, 10),
                    o = parseInt(o, 10),
                    r = parseInt(r, 10),
                    ...
                    this.showMeridian ? (12 < s && (n = 2,
                    s -= 12),
                    n || (n = 1),
                    0 === s && (s = 12),
                    a = 1 === n ? "AM" : "PM") : s < 12 && 2 === n ? s += 12 : s >= this.maxHours ? s = this.maxHours - 1 : (s < 0 || 12 === s && 1 === n) && (s = 0)
                }
                this.hour = s,
        ...
        showWidget: function() {
            ...
            f(i).on("mousedown.timepicker, touchend.timepicker", {
                scope: this
            ...
            "modal" === this.template && this.$widget.modal ? this.$widget.modal("show").on("hidden", f.proxy(this.hideWidget, this)) : !1 === this.isOpen && this.$widget.addClass("open"),
            this.isOpen = !0)
        },
        ...
        widgetKeydown: function(t) {
            ...
            case 9:
                ...
                } else if (this.showMeridian && "meridian" === n || this.showSeconds && "second" === n || !this.showMeridian && !this.showSeconds && "minute" === n)
                    return this.hideWidget();
                break;
            case 27:
                this.hideWidget();
    ...
    f.fn.timepicker = function(i) {
        ...
        this.each(function() {
            var t = f(this)
              , e = t.data("timepicker")
              , n = "object" == typeof i && i;
            e || t.data("timepicker", e = new o(this,f.extend({}, f.fn.timepicker.defaults, n, f(this).data()))),
    ...
    f(i).on("focus.timepicker.data-api click.timepicker.data-api", '[data-provide="timepicker"]', function(t) {
        var e = f(this);
        e.data("timepicker") || (t.preventDefault(),
        e.timepicker())
    })
}(jQuery, window, document),
function(n) {
    ...
    x.fn.TouchSpin = function(D) {
        ...
        return this.each(function() {
            var a, o, r, l, c, n, t, e, i, s, h = x(this), u = h.data(), d = 0, p = !1;
            function f() {
                "" === a.prefix && (o = c.prefix.detach()),
                "" === a.postfix && (r = c.postfix.detach())
            }
            function m() {
                var t, e, n;
                "" !== (t = a.callback_before_calculation(h.val())) ? 0 < a.decimals && "." === t || (e = parseFloat(t),
                ...
                Number(t).toString() !== n.toString() && (h.val(n),
                h.trigger("change"))) : "" !== a.replacementval && (h.val(a.replacementval),
                h.trigger("change"))
            }
            function g() {
                if (a.booster) {
                    var t = Math.pow(2, Math.floor(d / a.boostat)) * a.step;
                    return a.maxboostedstep && t > a.maxboostedstep && (t = a.maxboostedstep,
                    n = Math.round(n / t) * t),
                    Math.max(a.step, t)
                }
                return a.step
            ...
            function v() {
                m(),
                n = parseFloat(a.callback_before_calculation(c.input.val())),
                isNaN(n) && (n = 0);
                var t = n
                  , e = g();
                n += e,
                null !== a.max && n > a.max && (n = a.max,
                h.trigger("touchspin.on.max"),
                w()),
                c.input.val(a.callback_after_calculation(Number(n).toFixed(a.decimals))),
                t !== n && h.trigger("change")
            }
            function y() {
                m(),
                n = parseFloat(a.callback_before_calculation(c.input.val())),
            ...
            !function() {
                ...
                if (!h.data("alreadyinitialized"))
                    ...
                    S += 1,
                    h.data("spinnerid", S),
                    h.is("input") ? ("" !== (a = x.extend({}, k, u, (s = {},
                    x.each(C, function(t, e) {
                        var n = "bts-" + e;
                        h.is("[data-" + n + "]") && (s[t] = h.data(n))
                    }),
                    s), D)).initval && "" === h.val() && h.val(a.initval),
                    m(),
                    n = h.val(),
                    i = h.parent(),
                    "" !== n && (n = a.callback_after_calculation(Number(n).toFixed(a.decimals))),
                    h.data("initvalue", n).val(n),
                    h.addClass("form-control"),
                    i.hasClass("input-group") ? function(t) {
                        t.addClass("bootstrap-touchspin");
                        var e, n, i = h.prev(), s = h.next(), o = '<span class="input-group-addon input-group-prepend bootstrap-touchspin-prefix input-group-prepend bootstrap-touchspin-injected"><span class="input-group-text">' + a.prefix + "</span></span>", r = '<span class="input-group-addon input-group-append bootstrap-touchspin-postfix input-group-append bootstrap-touchspin-injected"><span class="input-group-text">' + a.postfix + "</span></span>";
                        i.hasClass("input-group-btn") || i.hasClass("input-group-prepend") ? (e = '<button class="' + a.buttondown_class + ' bootstrap-touchspin-down bootstrap-touchspin-injected" type="button">' + a.buttondown_txt + "</button>",
                        i.append(e)) : (e = '<span class="input-group-btn input-group-prepend bootstrap-touchspin-injected"><button class="' + a.buttondown_class + ' bootstrap-touchspin-down" type="button">' + a.buttondown_txt + "</button></span>",
                        x(e).insertBefore(h)),
                        s.hasClass("input-group-btn") || s.hasClass("input-group-append") ? (n = '<button class="' + a.buttonup_class + ' bootstrap-touchspin-up bootstrap-touchspin-injected" type="button">' + a.buttonup_txt + "</button>",
                        s.prepend(n)) : (n = '<span class="input-group-btn input-group-append bootstrap-touchspin-injected"><button class="' + a.buttonup_class + ' bootstrap-touchspin-up" type="button">' + a.buttonup_txt + "</button></span>",
                        x(n).insertAfter(h)),
                        x(o).insertBefore(h),
                        x(r).insertAfter(h),
                        l = t
                    }(i) : (e = "",
                    h.hasClass("input-sm") && (e = "input-group-sm"),
                    h.hasClass("input-lg") && (e = "input-group-lg"),
                    t = a.verticalbuttons ? '<div class="input-group ' + e + ' bootstrap-touchspin bootstrap-touchspin-injected"><span class="input-group-addon input-group-prepend bootstrap-touchspin-prefix"><span class="input-group-text">' + a.prefix + '</span></span><span class="input-group-addon bootstrap-touchspin-postfix input-group-append"><span class="input-group-text">' + a.postfix + '</span></span><span class="input-group-btn-vertical"><button class="' + a.buttondown_class + " bootstrap-touchspin-up " + a.verticalupclass + '" type="button">' + a.verticalup + '</button><button class="' + a.buttonup_class + " bootstrap-touchspin-down " + a.verticaldownclass + '" type="button">' + a.verticaldown + "</button></span></div>" : '<div class="input-group bootstrap-touchspin bootstrap-touchspin-injected"><span class="input-group-btn input-group-prepend"><button class="' + a.buttondown_class + ' bootstrap-touchspin-down" type="button">' + a.buttondown_txt + '</button></span><span class="input-group-addon bootstrap-touchspin-prefix input-group-prepend"><span class="input-group-text">' + a.prefix + '</span></span><span class="input-group-addon bootstrap-touchspin-postfix input-group-append"><span class="input-group-text">' + a.postfix + '</span></span><span class="input-group-btn input-group-append"><button class="' + a.buttonup_class + ' bootstrap-touchspin-up" type="button">' + a.buttonup_txt + "</button></span></div>",
                    l = x(t).insertBefore(h),
                    x(".bootstrap-touchspin-prefix", l).after(h),
                    h.hasClass("input-sm") ? l.addClass("input-group-sm") : h.hasClass("input-lg") && l.addClass("input-group-lg")),
                    c = {
                    ...
                    h.on("keydown.touchspin", function(t) {
                        ...
                        38 === e ? ("up" !== p && (v(),
                        _()),
                        t.preventDefault()) : 40 === e && ("down" !== p && (y(),
                        b()),
                        t.preventDefault())
                    }),
                    ...
                    h.on("blur.touchspin", function() {
                        m(),
                        h.val(a.callback_after_calculation(h.val()))
                    }),
                    ...
                    h.on("touchspin.destroy", function() {
                        ...
                        w(),
                        h.off(".touchspin"),
                        t.hasClass("bootstrap-touchspin-injected") ? (h.siblings().remove(),
                        h.unwrap()) : (x(".bootstrap-touchspin-injected", t).remove(),
                    ...
                    h.on("touchspin.updatesettings", function(t, n) {
                        !function(t) {
                            (function(t) {
                                (a = x.extend({}, a, t),
                                t.postfix) && (0 === h.parent().find(".bootstrap-touchspin-postfix").length && r.insertAfter(h),
                                h.parent().find(".bootstrap-touchspin-postfix .input-group-text").text(t.postfix));
                                t.prefix && (0 === h.parent().find(".bootstrap-touchspin-prefix").length && o.insertBefore(h),
                                h.parent().find(".bootstrap-touchspin-prefix .input-group-text").text(t.prefix));
                                f()
                            }
                            )(n),
                            m();
                            var e = c.input.val();
                            "" !== e && (e = Number(a.callback_before_calculation(c.input.val())),
                            c.input.val(a.callback_after_calculation(Number(e).toFixed(a.decimals))))
                        }()
...
function(v) {
    ...
    v.fn.extend({
        maxlength: function(h, t) {
            ...
            function p(t, e, n) {
                var i = "";
                return h.message ? i = "function" == typeof h.message ? h.message(t, e) : h.message.replace("%charsTyped%", n).replace("%charsRemaining%", e - n).replace("%charsTotal%", e) : (h.preText && (i += h.preText),
                i += h.showCharsTyped ? n : e - n,
                h.showMaxLength && (i += h.separator + e),
                h.postText && (i += h.postText)),
                i
            }
            function f(t, e, n, i) {
                var s, o, r, a, l;
                i && (i.html(p(e.val(), n, n - t)),
                0 < t ? (o = e,
                r = h.threshold,
                a = n,
                l = !0,
                !h.alwaysShow && a - c(o) > r && (l = !1),
                l ? d(e, i.removeClass(h.limitReachedClass).addClass(h.warningClass)) : (s = e,
                i.css({
                    display: "none"
                }),
                s.trigger("maxlength.hidden"))) : d(e, i.removeClass(h.warningClass).addClass(h.limitReachedClass))),
                h.allowOverMax && (t < 0 ? e.addClass("overmax") : e.removeClass("overmax"))
            }
            function m(t, e) {
                var n, i, s = (i = (n = t)[0],
                v.extend({}, "function" == typeof i.getBoundingClientRect ? i.getBoundingClientRect() : {
                    width: i.offsetWidth,
                    height: i.offsetHeight
                }, n.offset()));
                if ("function" !== v.type(h.placement))
                    if (v.isPlainObject(h.placement))
                        !function(t, e) {
                            if (t && e) {
                                var i = {};
                        ...
                        var o = t.outerWidth()
                          ...
                          , a = e.width()
                          , l = e.height();
                        switch (h.appendToParent && (s.top -= t.parent().offset().top,
                        s.left -= t.parent().offset().left),
                        h.placement) {
                        case "bottom":
                            e.css({
                                top: s.top + s.height,
            ...
            function g(t) {
                var e = "maxlength";
                return h.allowOverMax && (e = "data-bs-mxl"),
                t.attr(e) || t.attr("size")
            }
            var e = v("body");
            return v.isFunction(h) && !t && (t = h,
            h = {}),
            h = v.extend({
                showOnReady: !1,
                alwaysShow: !1,
            ...
            this.each(function() {
                function t() {
                    var t = p(c.val(), a, "0");
                    a = g(c),
                    l || (l = v('<span class="bootstrap-maxlength"></span>').css({
                        display: "none",
                        position: "absolute",
                        whiteSpace: "nowrap",
                        zIndex: 1099
                    }).html(t)),
                    c.is("textarea") && (c.data("maxlenghtsizex", c.outerWidth()),
                    c.data("maxlenghtsizey", c.outerHeight()),
                    c.mouseup(function() {
                        (c.outerWidth() !== c.data("maxlenghtsizex") || c.outerHeight() !== c.data("maxlenghtsizey")) && m(c, l),
                        c.data("maxlenghtsizex", c.outerWidth()),
                        c.data("maxlenghtsizey", c.outerHeight())
                    })),
                    h.appendToParent ? (c.parent().append(l),
                    c.parent().css("position", "relative")) : e.append(l),
                    f(u(c, g(c)), c, a, l),
                    m(c, l)
                }
                var a, l, c = v(this);
                ...
                h.allowOverMax && (v(this).attr("data-bs-mxl", v(this).attr("maxlength")),
                v(this).removeAttr("maxlength")),
                h.showOnReady ? c.ready(function() {
                    t()
                }) : c.focus(function() {
                    t()
                }),
                ...
                c.on("input", function() {
                    var t, e, n, i, s = g(c), o = u(c, s), r = !0;
                    return h.validate && o < 0 ? (e = s,
                    n = (t = c).val(),
                    i = 0,
                    h.twoCharLinebreak && "\n" === (n = n.replace(/\r(?!\n)|\n(?!\r)/g, "\r\n")).substr(n.length - 1) && n.length % 2 == 1 && (i = 1),
                    t.val(n.substr(0, e - i)),
                    r = !1) : f(o, c, a, l),
                    ("bottom-right-inside" === h.placement || "top-right-inside" === h.placement) && m(c, l),
                    r
                })
            })
        }
...
function(t) {
    ...
    function t(t, e) {
        return function() {
            return e !== T && S.fn.datepicker.deprecated(e),
    ...
    D.prototype = {
        ...
        _resolveDaysOfWeek: function(t) {
            return S.isArray(t) || (t = t.split(/[,\s]*/)),
            S.map(t, Number)
        },
        ...
        _process_options: function(t) {
            ...
            e.startDate !== -1 / 0 && (e.startDate ? e.startDate instanceof Date ? e.startDate = this._local_to_utc(this._zero_time(e.startDate)) : e.startDate = A.parseDate(e.startDate, i, e.language, e.assumeNearbyYear) : e.startDate = -1 / 0),
            e.endDate !== 1 / 0 && (e.endDate ? e.endDate instanceof Date ? e.endDate = this._local_to_utc(this._zero_time(e.endDate)) : e.endDate = A.parseDate(e.endDate, i, e.language, e.assumeNearbyYear) : e.endDate = 1 / 0),
            ...
            S.isArray(e.datesDisabled) || (e.datesDisabled = e.datesDisabled.split(",")),
            ...
            if (e.defaultViewDate instanceof Date || "string" == typeof e.defaultViewDate)
                e.defaultViewDate = A.parseDate(e.defaultViewDate, i, e.language, e.assumeNearbyYear);
        ...
        _buildEvents: function() {
            ...
            !0 === this.o.showOnFocus && (t.focus = S.proxy(this.show, this)),
        ...
        paste: function(t) {
            var e;
            if (t.originalEvent.clipboardData && t.originalEvent.clipboardData.types && -1 !== S.inArray("text/plain", t.originalEvent.clipboardData.types))
        ...
        setUTCDates: function() {
            var t = S.isArray(arguments[0]) ? arguments[0] : arguments;
            return this.setDates.apply(this, S.map(t, this._utc_to_local)),
            this
        },
        setDate: t("setDates"),
        ...
        place: function() {
            ...
            "right" === this.o.orientation.x && (u -= t - h)) : l.left < 0 ? (this.picker.addClass("datepicker-orient-left"),
            u -= l.left - 10) : i < u + t ? (this.picker.addClass("datepicker-orient-right"),
            u += h - t) : this.o.rtl ? this.picker.addClass("datepicker-orient-right") : this.picker.addClass("datepicker-orient-left");
            var p = this.o.orientation.y;
            if ("auto" === p && (p = -s + d - e < 0 ? "bottom" : "top"),
            this.picker.addClass("datepicker-orient-" + p),
            "top" === p ? d -= e + parseInt(this.picker.css("padding-top")) : d += c,
            this.o.rtl) {
                var f = i - (u + h);
                this.picker.css({
                    top: d,
        ...
        update: function() {
            ...
            e = !0) : (n = (n = this.isInput ? this.element.val() : this.element.data("date") || this.inputField.val()) && this.o.multidate ? n.split(this.o.multidateSeparator) : [n],
            delete this.element.data().date),
            n = S.map(n, S.proxy(function(t) {
                return A.parseDate(t, this.o.format, this.o.language, this.o.assumeNearbyYear)
            }, this)),
            n = S.grep(n, S.proxy(function(t) {
        ...
        fillDow: function() {
            if (this.o.showWeekDays) {
                ...
                for (this.o.calendarWeeks && (e += '<th class="cw">&#160;</th>'); t < this.o.weekStart + 7; )
                    e += '<th class="dow',
                    -1 !== S.inArray(t, this.o.daysOfWeekDisabled) && (e += " disabled"),
        ...
        getClassNames: function(t) {
            var e = []
              ...
              , s = w();
            return t.getUTCFullYear() < n || t.getUTCFullYear() === n && t.getUTCMonth() < i ? e.push("old") : (t.getUTCFullYear() > n || t.getUTCFullYear() === n && t.getUTCMonth() > i) && e.push("new"),
            ...
            -1 !== S.inArray(t.getUTCDay(), this.o.daysOfWeekHighlighted) && e.push("highlighted"),
            this.range && (t > this.range[0] && t < this.range[this.range.length - 1] && e.push("range"),
            -1 !== S.inArray(t.valueOf(), this.range) && e.push("selected"),
        ...
        _fill_yearsView: function(t, e, n, i, s, o, r) {
            for (var a, l, c, h = "", u = n / 10, d = this.picker.find(t), p = Math.floor(i / n) * n, f = p + 9 * u, m = Math.floor(this.viewDate.getFullYear() / u) * u, g = S.map(this.dates, function(t) {
                ...
                -1 !== S.inArray(v, g) && a.push("active"),
                (v < s || o < v) && a.push("disabled"),
                v === m && a.push("focused"),
                r !== S.noop && ((c = r(new Date(v,0,1))) === T ? c = {} : "boolean" == typeof c ? c = {
                    enabled: c
                } : "string" == typeof c && (c = {
                    classes: c
                }),
            ...
            d.find(".datepicker-switch").text(p + "-" + f),
            d.find("td").html(h)
        },
        fill: function() {
            var t, e, n = new Date(this.viewDate), s = n.getUTCFullYear(), i = n.getUTCMonth(), o = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCFullYear() : -1 / 0, r = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCMonth() : -1 / 0, a = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCFullYear() : 1 / 0, l = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCMonth() : 1 / 0, c = M[this.o.language].today || M.en.today || "", h = M[this.o.language].clear || M.en.clear || "", u = M[this.o.language].titleFormat || M.en.titleFormat;
            if (!isNaN(s) && !isNaN(i)) {
                this.picker.find(".datepicker-days .datepicker-switch").text(A.formatDate(n, u, this.o.language)),
                this.picker.find("tfoot .today").text(c).css("display", !0 === this.o.todayBtn || "linked" === this.o.todayBtn ? "table-cell" : "none"),
                this.picker.find("tfoot .clear").text(h).css("display", !0 === this.o.clearBtn ? "table-cell" : "none"),
                ...
                for (var m, g, v = []; d.valueOf() < f; ) {
                    if ((m = d.getUTCDay()) === this.o.weekStart && (v.push("<tr>"),
                    ...
                    !1 === e.enabled && g.push("disabled"),
                    e.classes && (g = g.concat(e.classes.split(/\s+/))),
                    e.tooltip && (t = e.tooltip),
                    e.content && (D = e.content)),
                    g = S.isFunction(S.uniqueSort) ? S.uniqueSort(g) : S.unique(g),
                    v.push('<td class="' + g.join(" ") + '"' + (t ? ' title="' + t + '"' : "") + ' data-date="' + d.getTime().toString() + '">' + D + "</td>"),
                    t = null,
                    m === this.o.weekEnd && v.push("</tr>"),
                ...
                (s < o || a < s) && C.addClass("disabled"),
                s === o && C.slice(0, r).addClass("disabled"),
                s === a && C.slice(l + 1).addClass("disabled"),
                this.o.beforeShowMonth !== S.noop) {
                    var x = this;
                    S.each(C, function(t, e) {
                        ...
                        !1 !== i.enabled || S(e).hasClass("disabled") || S(e).addClass("disabled"),
                        i.classes && S(e).addClass(i.classes),
                        i.tooltip && S(e).prop("title", i.tooltip)
                    })
                }
        ...
        click: function(t) {
            ...
            t.preventDefault(),
            t.stopPropagation(),
            (e = S(t.target)).hasClass("datepicker-switch") && this.viewMode !== this.o.maxViewMode && this.setViewMode(this.viewMode + 1),
            e.hasClass("today") && !e.hasClass("day") && (this.setViewMode(0),
            this._setDate(w(), "linked" === this.o.todayBtn ? null : "view")),
            ...
            this.viewMode === this.o.minViewMode ? this._setDate(E(n, i, 1)) : (this.setViewMode(this.viewMode - 1),
            this.fill())),
        ...
        navArrowsClick: function(t) {
            ...
            0 !== this.viewMode && (e *= 12 * A.viewModes[this.viewMode].navStep),
    ...
    var c = function(t, e) {
        ...
        s.call(S(this.inputs), e).on("changeDate", S.proxy(this.dateUpdated, this)),
        ...
        this.each(function() {
            ...
            if (!e) {
                var i = function(t, e) {
                    ...
                    for (var r in e = new RegExp("^" + e.toLowerCase()),
                    i)
                ...
                new c(this,o)) : new D(this,o),
                t.data("datepicker", e)
            }
            "string" == typeof r && "function" == typeof e[r] && (a = e[r].apply(e, l))
        }),
        a === T || a instanceof D || a instanceof c)
            return this;
        if (1 < this.length)
            throw new Error("Using only allowed for the collection of a single element (" + r + " function)");
        return a
    };
    S.fn.datepicker = s;
      ...
      , A = {
        ...
        parseDate: function(t, e, n, s) {
            ...
            if (t instanceof Date)
                return t;
            if ("string" == typeof e && (e = A.parseFormat(e)),
            e.toValue)
                return e.toValue(t, e, n);
            var o, r, a, l, c, h = {
                d: "moveDay",
                m: "moveMonth",
                w: "moveWeek",
            ...
            /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/i.test(t)) {
                for (o = t.match(/([\-+]\d+)([dmwy])/gi),
                t = new Date,
                l = 0; l < o.length; l++)
                    r = o[l].match(/([\-+]\d+)([dmwy])/i),
                    a = Number(r[1]),
                    c = h[r[2].toLowerCase()],
                    t = D.prototype[c](t, a);
            ...
            var d, p, f = {}, m = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], g = {
                yyyy: function(t, e) {
                    return t.setUTCFullYear(s ? (!0 === (i = s) && (i = 10),
                    (n = e) < 100 && (n += 2e3) > (new Date).getFullYear() + i && (n -= 100),
                    n) : e);
                    var n, i
                },
                m: function(t, e) {
            ...
            o.length === v.length) {
                ...
                for (l = 0,
                y = v.length; l < y; l++) {
                    if (d = parseInt(o[l], 10),
                    r = v[l],
                    isNaN(d))
                        switch (r) {
                        case "MM":
                            p = S(M[n].months).filter(i),
                            d = S.inArray(p[0], M[n].months) + 1;
                            break;
                        case "M":
                            p = S(M[n].monthsShort).filter(i),
                            d = S.inArray(p[0], M[n].monthsShort) + 1
                        }
                    f[r] = d
                }
                for (l = 0; l < m.length; l++)
                    (_ = m[l])in f && !isNaN(f[_]) && (b = new Date(t),
                    g[_](b, f[_]),
                    isNaN(b) || (t = b))
            }
            return t
    ...
    S.fn.datepicker.DPGlobal = A,
    S.fn.datepicker.noConflict = function() {
        return S.fn.datepicker = i,
        this
    }
    ,
    S.fn.datepicker.version = "1.8.0",
...
function(o) {
    ...
    ,
    o.AdvanceFormApp = new t,
    o.AdvanceFormApp.Constructor = t
}(window.jQuery),
function(c) {
    "use strict";
    var t = function() {};
...
function(n) {
    ...
    var t = function() {
        ...
        this.menuContainer = n(".slimscroll-menu")
    };
    ...
    t.prototype._reset = function() {
        ...
        n("#side-main-logo").attr("src", "assets/images/logo.png"),
        n("#side-sm-main-logo").attr("src", "assets/images/logo_sm.png")
    }
    ,
    ...
    t.prototype.deactivateScrollableSidebar = function() {
        this.body.removeAttr("data-leftbar-compact-mode"),
        n("#left-side-menu-container").addClass("slimscroll-menu"),
        this._resetSidebarScroll()
    }
    ,
    ...
    t.prototype.activateLightTheme = function() {
        this._reset(),
        n("#side-main-logo").attr("src", "assets/images/logo-dark.png"),
        n("#side-sm-main-logo").attr("src", "assets/images/logo_sm_dark.png"),
    ...
    t.prototype.initMenu = function() {
        var e = this;
        this._reset(),
        n(".side-nav").metisMenu(),
        this.body.hasClass("scrollable-layout") && n("#left-side-menu-container").removeClass("slimscroll-menu"),
        this._resetSidebarScroll(),
        ...
        n(".side-nav a").each(function() {
            ...
            this.href == t && (n(this).addClass("active"),
            ...
            n(this).parent().parent().parent().parent().parent().parent().addClass("mm-show"),
            n(this).parent().parent().parent().parent().parent().parent().parent().addClass("mm-active"))
        }),
...
function(n) {
    ...
    t.prototype._activateLayout = function(t) {
        ...
        case "vertical":
            n.App.activateVerticalLayout(function() {
                n("input[type=radio][name=theme]").prop("disabled", !1),
                n("input[type=radio][name=compact]").prop("disabled", !1),
                n("input[type=radio][name=width]").prop("disabled", !1)
            });
            break;
        case "horizontal":
        ...
        case "detached":
            n.App.activateDetachedlLayout(function() {
                ...
                n("#default-check").prop("checked", !0),
                n("#scrollable-check").prop("checked", !0),
    ...
    t.prototype._selectOptionsFromConfig = function() {
        ...
        if (t) {
            switch (t.layout) {
            case "vertical":
                n("#vertical-check").prop("checked", !0),
                n("input[type=radio][name=theme]").prop("disabled", !1),
                n("input[type=radio][name=compact]").prop("disabled", !1),
                n("input[type=radio][name=width]").prop("disabled", !1);
                break;
            case "horizontal":
                n("#horizontal-check").prop("checked", !0),
                n("input[type=radio][name=width]").prop("disabled", !1),
                n("input[type=radio][name=theme]").prop("disabled", !0),
                n("input[type=radio][name=compact]").prop("disabled", !0);
                break;
            case "detached":
                ...
                n("input[type=radio][name=theme]").prop("disabled", !0),
                n("input[type=radio][name=compact]").prop("disabled", !1),
                n("#detached-check").prop("checked", !0)
            }
            ...
            t.isBoxed ? n("#boxed-check").prop("checked", !0) : n("#fluid-check").prop("checked", !0),
            t.isCondensed && n("#condensed-check").prop("checked", !0),
            t.isScrollable && n("#scrollable-check").prop("checked", !0),
            t.isScrollable || t.isCondensed || n("#fixed-check").prop("checked", !0),
            t.isDarkModeEnabled || (n("#light-mode-check").prop("checked", !0),
            "vertical" === t.layout && n("input[type=radio][name=theme]").prop("disabled", !1)),
            t.isDarkModeEnabled && n("#dark-mode-check").prop("checked", !0)
        }
    }
    ,
    ...
    t.prototype.init = function() {
        ...
        n(document).on("click", "body", function(t) {
            0 < n(t.target).closest(".right-bar-toggle, .right-bar").length || 0 < n(t.target).closest(".left-side-menu, .side-nav").length || n(t.target).hasClass("button-menu-mobile") || 0 < n(t.target).closest(".button-menu-mobile").length || (n("body").removeClass("right-bar-enabled"),
            n("body").removeClass("sidebar-enable"))
        }),
        n("input[type=radio][name=layout]").change(function() {
            e._activateLayout(n(this).val()),
            n("#fluid-check").prop("checked", !0),
            n.App.activateFluid()
        }),
        n("input[type=radio][name=width]").change(function() {
            ...
            case "fluid":
                n.App.activateFluid(),
                e._activateLayout(n("input[type=radio][name=layout]:checked").val());
                break;
            case "boxed":
                n.App.activateBoxed()
            }
        ...
        n("input[type=radio][name=compact]").change(function() {
            switch (n(this).val()) {
            case "fixed":
                n.App.deactivateCondensedSidebar(),
                n.App.deactivateScrollableSidebar();
                break;
            case "scrollable":
        ...
        n("input[type=radio][name=color-scheme-mode]").change(function() {
            switch (n(this).val()) {
            case "light":
                n.App.deactivateDarkMode(),
                n("#default-check").prop("checked", !0),
                n("input[type=radio][name=theme]").prop("disabled", !1);
                break;
            case "dark":
                n.App.activateDarkMode(),
                n("#default-check").prop("checked", !0),
                n("input[type=radio][name=theme]").prop("disabled", !0)
            }
        }),
...
function(i) {
    ...
    var n = "vertical"
      ...
      , t = function() {
        ...
        this.verticalSidebarPH = i("#vertical-sidebar-placeholder"),
        this.verticalTopbarPH = i("#vertical-topbar-placeholder"),
        ...
        this.currentlyActivatedLayout = n,
        this._config = {}
    };
    ...
    t.prototype.activateVertical = function(t) {
        ...
        e._resetMenuContent(),
        e._resetLayout(),
        i.when(i.get(e._partials.VERTICAL_SIDEBAR, function(t) {
    ...
    t.prototype.activateHorizontal = function(e) {
        ...
        n._resetMenuContent(),
        n._resetLayout(),
        i.get(n._partials.HORIZONTAL_TOPBAR, function(t) {
            n.horizontalTopbarPH.append(t),
            n.verticalSidebarPH.html(""),
            n.verticalTopbarPH.html(""),
            n.body.attr("data-layout", "topnav"),
            i.Topbar.initMenu(),
            n._saveConfig({
                layout: s,
                isBoxed: !1,
    ...
    t.prototype.activateDetached = function(t) {
        ...
        e._resetMenuContent(),
        e._resetLayout(),
        i.when(i.get(e._partials.DETAHCED_TOPBAR, function(t) {
            e.detachedTopbarPH.append(t)
        }), i.get(e._partials.DETAHCED_SIDEBAR, function(t) {
            e.detachedSidebarPH.append(t)
        })).then(function() {
            e.body.attr("data-layout", "detached"),
            i.LeftSidebar.initMenu(),
            e._saveConfig({
                layout: o,
                isBoxed: !1
            }),
    ...
    t.prototype.activateDefaultSidebarTheme = function() {
        i.LeftSidebar.activateDefaultTheme(),
        this._saveConfig({
            sideBarTheme: "default"
        })
    }
    ...
    t.prototype.activateLightSidebarTheme = function() {
        this._config.layout === n && (i.LeftSidebar.activateLightTheme(),
        this._saveConfig({
            sideBarTheme: "light"
        }))
    }
    ...
    t.prototype.activateDarkSidebarTheme = function() {
        this._config.layout === n && (i.LeftSidebar.activateDarkTheme(),
        this._saveConfig({
            sideBarTheme: "dark"
        }))
    }
    ...
    t.prototype.activateDarkMode = function() {
        i("#main-style-container").attr("href", "assets/css/app-dark.min.css"),
        this._saveConfig({
            isDarkModeEnabled: !0
        })
    }
    ...
    t.prototype.deactivateDarkMode = function() {
        i("#main-style-container").attr("href", "assets/css/app.min.css"),
        this._saveConfig({
            isDarkModeEnabled: !1
        })
    }
    ...
    ,
    i.LayoutThemeApp = new t,
    i.LayoutThemeApp.Constructor = t
}(window.jQuery),
function(e) {
    "use strict";
    var t = function() {
    ...
    t.prototype.init = function() {
        ...
        e.RightBar.init(),
        window.sessionStorage) && (sessionStorage.getItem("_HYPER_VISITED_") || (e.RightBar.toggleRightSideBar(),
